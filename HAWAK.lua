...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1054308380,1842536919}
...
io.popen("mkdir HAWAK_Files")
t = "\27[35m".."\nAll Files Started : \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..'\27[m'
i = 0
for v in io.popen('ls HAWAK_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."HAWAK:Sudo:User", msg.sender_user_id_) 
if hash or Bot(msg) or DevHAWAK(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or DevBot(msg) or DevHAWAK(msg) or VIP_DeV(msg) then    
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevHAWAK(msg) or DevBot(msg) or VIP_DeV(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."HAWAK:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevHAWAK(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."HAWAK:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevHAWAK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."HAWAK:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevHAWAK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."HAWAK:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevHAWAK(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
...
function Vips(msg)
local hash = database:sismember(bot_id.."HAWAK:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or Bot(msg) or  DevHAWAK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
function CleangGroups();local z = io.open('./HAWAK');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/HAWAK.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
function General_ban(user_id,chat_id)
if DevHAWAKe(user_id) == true then
var = true
elseif DevHAWAK(user_id) == true then
var = true
...
var = true  
elseif tonumber(user_id) == tonumber(1842536919) then
var = true  
...
var = true  
elseif database:sismember(bot_id.."HAWAK:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."creator"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."HAWAK:Basic:Constructor"..chat_id, user_id) then
var = true                 
elseif database:sismember(bot_id.."HAWAK:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."HAWAK:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."HAWAK:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."HAWAK:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."HAWAK:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
elseif tonumber(user_id) == tonumber(1842536919) then  
var = "مبرمج السورس"  
elseif DevHAWAKe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then  var = "االمطور الاساسي ²"  
elseif database:sismember(bot_id.."HAWAK:Sudo:User", user_id) then
var = database:get(bot_id.."HAWAK:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."creator"..chat_id,user_id) then var = "المالك"
elseif database:sismember(bot_id.."HAWAK:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."HAWAK:BasicConstructor:Rd"..chat_id) or "المنشئ الاساسي"
elseif database:sismember(bot_id.."HAWAK:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."HAWAK:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."HAWAK:Manager"..chat_id, user_id) then
var = database:get(bot_id.."HAWAK:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."HAWAK:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."HAWAK:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."HAWAK:MN:TF"..chat_id, user_id) then
var =  "منظف"  
elseif database:sismember(bot_id.."HAWAK:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."HAWAK:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."HAWAK:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
...
if database:sismember(bot_id.."HAWAK:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."HAWAK:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."HAWAK:GBan:User",User_id) then
Var = true
else
Var = false
end
...
local listsudo = database:smembers(bot_id.."HAWAK:Sudo:User"..chat_id)
local listasa = database:smembers(bot_id.."HAWAK:Basic:Constructor"..chat_id)
local listmnsh = database:smembers(bot_id.."HAWAK:Constructor"..chat_id)
local listmder = database:smembers(bot_id.."HAWAK:Manager"..chat_id)
local listadmin = database:smembers(bot_id.."HAWAK:Mod:User"..chat_id)
local listvip = database:smembers(bot_id.."HAWAK:Special:User"..chat_id)
local listbans = database:smembers(bot_id.."HAWAK:GBan:User"..chat_id)
local listban = database:smembers(bot_id.."HAWAK:Ban:User"..chat_id)
local listktm = database:smembers(bot_id.."HAWAK:Muted:User"..chat_id)
local listcleanerr = database:smembers(bot_id.."HAWAK:MN:TF"..chat_id)
local listCmdd = database:smembers(bot_id.."HAWAK:List:Cmd:Group:New"..chat_id)
...
url = 'https://raw.githubusercontent.com/SourceHawak/HAWAK/master/HAWAK.lua'
file_path = 'HAWAK.lua'
local respbody = {} 
...
local Texti = '*\n◊￤اعدادات المجموعه \n◊￤علامة ال {✅} تعني مقفول\n◊￤علامة ال {❌} تعني مفتوح*'
local mute_photo = (database:get(bot_id.."HAWAK:Lock:Photo"..chat) or '{❌}')
local mute_photo1 = mute_photo:gsub('del', '{✅}')
local mute_audio = (database:get(bot_id.."HAWAK:Lock:vico"..chat) or '{❌}')
local mute_audio1 = mute_audio:gsub('del', '{✅}')
local mute_voice = (database:get(bot_id.."HAWAK:Lock:Audio"..chat) or '{❌}')
local mute_voice1 = mute_voice:gsub('del', '{✅}')
local mute_forward = (database:get(bot_id.."HAWAK:Lock:forward"..chat) or '{❌}')
local mute_forward1 = mute_forward:gsub('del', '{✅}')
local mute_document = (database:get(bot_id.."HAWAK:Lock:Document"..chat) or '{❌}')
local mute_document1 = mute_document:gsub('del', '{✅}')
local mute_contact = (database:get(bot_id.."HAWAK:Lock:Contact"..chat) or '{❌}')
local mute_contact1 = mute_contact:gsub('del', '{✅}')
local lock_spam = (database:get(bot_id.."HAWAK:Lock:Spam"..chat) or '{❌}')
local lock_spam1 = lock_spam:gsub('del', '{✅}')
local lock_flood = (database:hget(bot_id.."HAWAK:flooding:settings:"..chat ,"flood") or '{❌}')
local lock_flood1 = lock_flood:gsub('del', '{✅}')
local mute_inline = (database:get(bot_id.."HAWAK:Lock:Inlen"..chat) or '{❌}')
...
local Texti = '*\n◊￤اعدادات المجموعه \n◊￤علامة ال {✅} تعني مقفول\n◊￤علامة ال {❌} تعني مفتوح*'
local mute_text = (database:get(bot_id.."HAWAK:Lock:text"..chat)  or '{❌}')
local mute_text1 = mute_text:gsub('true', '{✅}')
local lock_bots = (database:get(bot_id.."HAWAK:Lock:Bot:kick"..chat) or '{❌}')
local lock_bots1 = lock_bots:gsub('kick', '{✅}')
local mute_tgservice = (database:get(bot_id.."HAWAK:Lock:tagservr"..chat) or '{❌}')
local mute_tgservice1 = mute_tgservice:gsub('true', '{✅}')
local lock_edit = (database:get(bot_id.."HAWAK:Lock:edit"..chat) or '{❌}')
local lock_edit1 = lock_edit:gsub('true', '{✅}')
local lock_link = (database:get(bot_id.."HAWAK:Lock:Link"..chat) or '{❌}')
local lock_link1 = lock_link:gsub('del', '{✅}')
local lock_username = (database:get(bot_id.."HAWAK:Lock:User:Name"..chat) or '{❌}')
local lock_username1 = lock_username:gsub('del', '{✅}')
local lock_tag = (database:get(bot_id.."HAWAK:Lock:hashtak"..chat) or '{❌}')
local lock_tag1 = lock_tag:gsub('del', '{✅}')
local mute_sticker = (database:get(bot_id.."HAWAK:Lock:Sticker"..chat) or '{❌}')
local mute_sticker1 = mute_sticker:gsub('del', '{✅}')
local mute_gif = (database:get(bot_id.."HAWAK:Lock:Animation"..chat) or '{❌}')
local mute_gif1 = mute_gif:gsub('del', '{✅}')
local mute_video = (database:get(bot_id.."HAWAK:Lock:Video"..chat) or '{❌}')
...
local UserName = (data.username_ or "HAWAK_Source")
local NameUser = "\n*◊￤بواسطه ⇠* ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "\n*◊￤المستخدم ⇠* ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
key = {{{text = 'ʜᴀᴡᴀᴋ ᴛᴇᴀᴍ', url="https://t.me/lllEll2"}}}   
...
database:set(bot_id.."HAWAK:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'HAWAK:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."HAWAK:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."HAWAK:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."HAWAK:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."HAWAK:Basic:Constructor"..idg,idASAS)  
end;end
if v.Status_Dev then
if v.Status_Dev ~= "" then
database:set(bot_id.."HAWAK:Sudo:Rd"..idg,v.Status_Dev)
end
end
if v.Status_Prt then
if v.Status_Prt ~= "" then
database:set(bot_id.."HAWAK:BasicConstructor:Rd"..idg,v.Status_Prt)
end
end
if v.Status_Cto then
if v.Status_Cto ~= "" then
database:set(bot_id.."HAWAK:Constructor:Rd"..idg,v.Status_Cto)
end
end
if v.Status_Own then
if v.Status_Own ~= "" then
database:set(bot_id.."HAWAK:Manager:Rd"..idg,v.Status_Own) 
end
end
if v.Status_Md then
if v.Status_Md ~= "" then
database:set(bot_id.."HAWAK:Mod:Rd"..idg,v.Status_Md)
end
end
if v.Status_Vip then
if v.Status_Vip ~= "" then
database:set(bot_id.."HAWAK:Special:Rd"..idg,v.Status_Vip)
end
end
if v.Status_Mem then
if v.Status_Mem ~= "" then
database:set(bot_id.."HAWAK:Memp:Rd"..idg,v.Status_Mem)
end
end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."HAWAK:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function HAWAK_Files(msg)
for v in io.popen('ls HAWAK_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("HAWAK_Files/"..v)
if plugin.HAWAK and msg then
pre_msg = plugin.HAWAK(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function HAWAK_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'HAWAK:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'HAWAK:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
...
function Function_HAWAK(arg, data)
msg = arg.msg
if data.id_ then
...
local HAWAK_Info_Sudo = io.open("sudo.lua", 'w')
HAWAK_Info_Sudo:write([[
token = "]]..token..[["
...
tdcli_function ({ID = "SearchPublicChat",username_ = text},Function_HAWAK,{msg=msg})
...
if database:get(bot_id.."HAWAK:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◊￤" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء الاذاعه") 
database:del(bot_id.."HAWAK:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
...
database:set(bot_id..'HAWAK:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'HAWAK:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'HAWAK:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'HAWAK:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not creatorA(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."HAWAK:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."HAWAK:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."HAWAK:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."HAWAK:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."HAWAK:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."HAWAK:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."HAWAK:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."HAWAK:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:Link"..msg.chat_id_) == "del" and not Addictive(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Link"..msg.chat_id_) == "ked" and not Addictive(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Link"..msg.chat_id_) == "kick" and not Addictive(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Link"..msg.chat_id_) == "ktm" and not Addictive(msg) then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."HAWAK:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."HAWAK:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."HAWAK:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."HAWAK:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."HAWAK:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."HAWAK:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."HAWAK:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."HAWAK:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."HAWAK:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
local status_welcome = database:get(bot_id.."HAWAK:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."HAWAK:Status:Lock:tagservr"..msg.chat_id_) then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."HAWAK:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."HAWAK:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."HAWAK:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."HAWAK:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."HAWAK:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."HAWAK:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."HAWAK:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"◊￤تم الغاء وضع الوصف") 
database:del(bot_id.."HAWAK:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."HAWAK:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."HAWAK:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"◊￤تم الغاء حفظ الترحيب") 
database:del(bot_id.."HAWAK:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."HAWAK:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."HAWAK:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"◊￤تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."HAWAK:Set:PHAWAKvate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"◊￤تم الغاء حفظ الرابط")       
database:del(bot_id.."HAWAK:Set:PHAWAKvate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
...
if database:get(bot_id.."HAWAK:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◊￤" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء الاذاعه للخاص") 
database:del(bot_id.."HAWAK:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'HAWAK:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."HAWAK:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◊￤" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء الاذاعه") 
database:del(bot_id.."HAWAK:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."HAWAK:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◊￤" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء الاذاعه") 
database:del(bot_id.."HAWAK:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."HAWAK:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◊￤" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء الاذاعه") 
database:del(bot_id.."HAWAK:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."HAWAK:UsersBot")   
...
local HAWAK_Msg = database:sismember(bot_id.."HAWAK:List:Filter:text"..msg.chat_id_,text) 
if HAWAK_Msg then    
...
if msg.content_.ID == 'MessageAnimation' and not Vips(msg) then      
local geAni = database:sismember(bot_id.."HAWAK:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_) 
if geAni then        
...
if msg.content_.ID == 'MessageSticker' and not Vips(msg) then      
local ker = database:sismember(bot_id.."HAWAK:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_) 
if ker then        
...
if msg.content_.ID == 'MessagePhoto' and not Vips(msg) then      
local phh = database:sismember(bot_id.."HAWAK:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_) 
if phh then        
...
if database:get(bot_id.."HAWAK:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◊￤" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء حفظ اسم البوت") 
database:del(bot_id.."HAWAK:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."HAWAK:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."HAWAK:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "◊￤تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."HAWAK:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."HAWAK:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"◊￤ارسل الامر الجديد ليتم وضعه مكان القديم")  
database:del(bot_id.."HAWAK:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."HAWAK:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."HAWAK:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."HAWAK:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"◊￤تم حفظ الامر باسم ⇠ { "..text..' }')  
database:del(bot_id.."HAWAK:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:sadd(bot_id.."HAWAK:allM"..msg.chat_id_, msg.id_)
end
...
local gmedia = database:scard(bot_id.."HAWAK:allM"..msg.chat_id_)  
local Numbardel = database:get(bot_id.."HAWAK:allM:numdel"..msg.chat_id_)  or 200
if gmedia >= tonumber(Numbardel) then
local liste = database:smembers(bot_id.."HAWAK:allM"..msg.chat_id_)
...
local gmria = database:scard(bot_id.."HAWAK:allM"..msg.chat_id_)  
...
database:set(bot_id.."HAWAK:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."HAWAK:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."HAWAK:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."HAWAK:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."HAWAK:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."HAWAK:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."HAWAK:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."HAWAK:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."HAWAK:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."HAWAK:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."HAWAK:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'HAWAK:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."HAWAK:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."HAWAK:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."HAWAK:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."HAWAK:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."HAWAK:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."HAWAK:lockpin"..msg.chat_id_)  
database:srem(bot_id.."HAWAK:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."HAWAK:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."HAWAK:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'HAWAK:'..lock..msg.chat_id_)    
end
...
database:del(bot_id.."HAWAK:Lock:Link"..msg.chat_id_)  
...
database:del(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_)  
...
database:del(bot_id.."HAWAK:Lock:Animation"..msg.chat_id_)  
...
database:del(bot_id.."HAWAK:Lock:Sticker"..msg.chat_id_)  
...
database:hset(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_ ,"flood","kick")  
...
database:hset(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_ ,"flood","del")  
...
database:hset(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_ ,"flood","keed")  
...
database:hset(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_ ,"flood","mute")  
...
database:hdel(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_ ,"flood")  
...
function Function_HAWAK(extra, result, success)
database:sadd(bot_id.."DEV:Sudo:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","*◊￤تم رفعه مطور ثانوي*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_HAWAK, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_HAWAK, nil)
return false 
end
...
if text == ("الثانويين") and DevHAWAK(msg) then
local list = database:smembers(bot_id.."DEV:Sudo:T")
t = "\n*◊￤قائمة مطورين الثانويين للبوت *\n*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."HAWAK:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.."`)\n"
...
if text == ("مسح قائمه العام") and DevHAWAK(msg) then
database:del(bot_id.."HAWAK:GBan:User")
send(msg.chat_id_, msg.id_, "\n◊￤تم مسح قائمه العام")
return false
end
if text == ("قائمه العام") and DevHAWAK(msg) then
local list = database:smembers(bot_id.."HAWAK:GBan:User")
t = "\n◊￤قائمة المحظورين عام \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."HAWAK:User:Name" .. v)
if username then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevHAWAK(msg) then
function Function_HAWAK(extra, result, success)
if General_ban(result, result.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\n*◊￤لا يمكنك (طرد ꒐ حظر ꒐ كتم ꒐ تقييد) *( "..Get_Rank(result.sender_user_id_,msg.chat_id_).." )")
else
database:sadd(bot_id.."HAWAK:GBan:User", result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and DevHAWAK(msg) then
...
if result.id_ == tonumber(1842536919) then
...
database:sadd(bot_id.."HAWAK:GBan:User", result.id_)
...
if text and text:match("^حظر عام (%d+)$") and DevHAWAK(msg) then
...
if userid == tonumber(1842536919) then
send(msg.chat_id_, msg.id_, "◊￤لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مبرمج السورس \n")
return false 
end
...
database:sadd(bot_id.."HAWAK:GBan:User", userid)
Reply_Status(msg,userid,"reply","◊￤تم حظره عام من المجموعات")  
return false
end
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevHAWAK(msg) then
function Function_HAWAK(extra, result, success)
if General_ban(result, result.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\n*◊￤لا يمكنك (طرد ꒐ حظر ꒐ كتم ꒐ تقييد) *( "..Get_Rank(result.sender_user_id_,msg.chat_id_).." )")
else
...
if text and text:match("^كتم عام @(.*)$")  and DevHAWAK(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevHAWAK(msg) then
local userid = text:match("^حظر عام (%d+)$")
if userid == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "◊￤لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevHAWAK(msg) then
function Function_HAWAK(extra, result, success)
database:srem(bot_id.."HAWAK:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◊￤تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_HAWAK, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and DevHAWAK(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_HAWAK(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","◊￤تم الغاء حظره عام من المجموعات")  
database:srem(bot_id.."HAWAK:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"◊￤لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and DevHAWAK(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."HAWAK:GBan:User", userid)
Reply_Status(msg,userid,"reply","◊￤تم الغاء حظره عام من المجموعات")  
return false
end

if text == ("مسح المطورين") and DevHAWAK(msg) then
database:del(bot_id.."HAWAK:Sudo:User")
send(msg.chat_id_, msg.id_, "\n◊￤تم مسح قائمة المطورين  ")
end
if text == "مسح المنشئين الاساسين" and DevBot(msg) then
database:del(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_)
...
database:del(bot_id.."HAWAK:Constructor"..msg.chat_id_)
...
database:del(bot_id.."HAWAK:Manager"..msg.chat_id_)
...
database:del(bot_id.."HAWAK:Mod:User"..msg.chat_id_)
...
database:del(bot_id.."HAWAK:Special:User"..msg.chat_id_)
...
database:del(bot_id.."HAWAK:Muted:User"..msg.chat_id_)
...
database:del(bot_id.."HAWAK:Ban:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "\n◊￤تم مسح المحظورين")
end
if text == ("قائمه العام") and DevHAWAK(msg) then
local list = database:smembers(bot_id.."HAWAK:GBan:User")
...
if text == ("المطورين") and DevHAWAK(msg) then
local list = database:smembers(bot_id.."HAWAK:Sudo:User")
t = "\n◊￤قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."HAWAK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."HAWAK:Constructor"..msg.chat_id_)
t = "\n◊￤قائمة المنشئين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."HAWAK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."HAWAK:Manager"..msg.chat_id_)
t = "\n◊￤قائمة المدراء \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."HAWAK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."HAWAK:Mod:User"..msg.chat_id_)
t = "\n◊￤قائمة الادمنيه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."HAWAK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."HAWAK:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."HAWAK:Muted:User"..msg.chat_id_)
t = "\n◊￤قائمة المكتومين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."HAWAK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."HAWAK:Ban:User"..msg.chat_id_)
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevHAWAK(msg) then
function Function_HAWAK(extra, result, success)
database:sadd(bot_id.."HAWAK:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◊￤تم رفعه مطور")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_HAWAK, nil)
return false 
end
if text and text:match("^اضف مطور @(.*)$") and DevHAWAK(msg) then
...
database:sadd(bot_id.."HAWAK:Sudo:User", result.id_)
...
if text and text:match("^اضف مطور (%d+)$") and DevHAWAK(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."HAWAK:Sudo:User", userid)
Reply_Status(msg,userid,"reply","◊￤تم رفعه مطور")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevHAWAK(msg) then
function Function_HAWAK(extra, result, success)
database:srem(bot_id.."HAWAK:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◊￤تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_HAWAK, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and DevHAWAK(msg) then
local username = text:match("^حذف مطور @(.*)$")
function Function_HAWAK(extra, result, success)
if result.id_ then
database:srem(bot_id.."HAWAK:Sudo:User", result.id_)
...
if text and text:match("^حذف مطور (%d+)$") and DevHAWAK(msg) then
local userid = text:match("^حذف مطور (%d+)$")
database:srem(bot_id.."HAWAK:Sudo:User", userid)
...
if text == ("رفع مالك") and tonumber(msg.reply_to_message_id_) ~= 0 and DevHAWAK(msg) then  
function Function_HAWAK(extra, result, success)
...
if text and text:match("^رفع مالك @(.*)$") and DevHAWAK(msg) then  
...
if text and text:match("^رفع مالك (%d+)$") and DevHAWAK(msg) then  
...
if text and text:match("^تنزيل مالك @(.*)$") and DevHAWAK(msg) then  
...
if text and text:match("^تنزيل مالك (%d+)$") and DevHAWAK(msg) then  
...
function Function_HAWAK(extra, result, success)
database:sadd(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_HAWAK(extra, result, success)
database:srem(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_HAWAK(extra, result, success)
if result.id_ then
database:srem(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_HAWAK(extra, result, success)
database:sadd(bot_id.."HAWAK:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."HAWAK:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."HAWAK:Constructor"..msg.chat_id_, userid)
...
function Function_HAWAK(extra, result, success)
database:srem(bot_id.."HAWAK:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◊￤تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_HAWAK, nil)
end
...
function Function_HAWAK(extra, result, success)
if result.id_ then
database:srem(bot_id.."HAWAK:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","◊￤تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"◊￤لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."HAWAK:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","◊￤تم تنزيله من المنشئين")  
end
...
function Function_HAWAK(extra, result, success)
database:sadd(bot_id.."HAWAK:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."HAWAK:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."HAWAK:Manager"..msg.chat_id_, userid)
...
function Function_HAWAK(extra, result, success)
database:srem(bot_id.."HAWAK:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_HAWAK(extra, result, success)
if result.id_ then
database:srem(bot_id.."HAWAK:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."HAWAK:Manager"..msg.chat_id_, userid)
...
function Function_HAWAK(extra, result, success)
database:sadd(bot_id.."HAWAK:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."HAWAK:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."HAWAK:Mod:User"..msg.chat_id_, userid)
...
function Function_HAWAK(extra, result, success)
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_HAWAK(extra, result, success)
if result.id_ then
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_, userid)
...
function Function_HAWAK(extra, result, success)
database:sadd(bot_id.."HAWAK:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."HAWAK:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."HAWAK:Special:User"..msg.chat_id_, userid)
...
function Function_HAWAK(extra, result, success)
database:srem(bot_id.."HAWAK:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_HAWAK(extra, result, success)
if result.id_ then
database:srem(bot_id.."HAWAK:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."HAWAK:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."HAWAK:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local HAWAKrt = database:get(bot_id.."HAWAK:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if HAWAKrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"◊￤العضو ⇠ ["..data.first_name_.."](t.me/"..(data.username_ or "HAWAK_Source")..")".."\n◊￤تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."HAWAK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."HAWAK:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif HAWAKrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"◊￤العضو ⇠ ["..data.first_name_.."](t.me/"..(data.username_ or "HAWAK_Source")..")".."\n◊￤تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."HAWAK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."HAWAK:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif HAWAKrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"◊￤العضو ⇠ ["..data.first_name_.."](t.me/"..(data.username_ or "HAWAK_Source")..")".."\n◊￤تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."HAWAK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."HAWAK:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif HAWAKrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"◊￤العضو ⇠ ["..data.first_name_.."](t.me/"..(data.username_ or "HAWAK_Source")..")".."\n◊￤تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
database:srem(bot_id.."HAWAK:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."HAWAK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif HAWAKrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"◊￤العضو ⇠ ["..data.first_name_.."](t.me/"..(data.username_ or "HAWAK_Source")..")".."\n• تم تنزيله من "..RTPA.." هنا\n")  
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."HAWAK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."HAWAK:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local HAWAKrt = database:get(bot_id.."HAWAK:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if HAWAKrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"◊￤العضو ⇠ ["..result.title_.."](t.me/"..(text1[3] or "HAWAK_Source")..")".."\n◊￤تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."HAWAK:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."HAWAK:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif HAWAKrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"◊￤العضو ⇠ ["..result.title_.."](t.me/"..(text1[3] or "HAWAK_Source")..")".."\n◊￤تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."HAWAK:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."HAWAK:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."HAWAK:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."HAWAK:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif HAWAKrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"◊￤العضو ⇠ ["..result.title_.."](t.me/"..(text1[3] or "HAWAK_Source")..")".."\n• تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."HAWAK:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
if result.sender_user_id_ == tonumber(18425369191100) then
send(msg.chat_id_, msg.id_, "◊￤لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
database:sadd(bot_id.."HAWAK:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_) 
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local UserName = (data.username_ or "HAWAK_Source")
local NameUserr = "\n*◊￤المستخدم ⇠* ["..data.first_name_.."](T.me/"..UserName..")\n"
...
database:sadd(bot_id.."HAWAK:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."HAWAK:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."HAWAK:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."HAWAK:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."HAWAK:Ban:User"..msg.chat_id_, userid)
...
if result.sender_user_id_ == tonumber(1842536919) then
send(msg.chat_id_, msg.id_, "◊￤لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مبرمج السورس \n")
return false 
end
...
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local UserName = (data.username_ or "HAWAK_Source")
local NameUserr = "\n*◊￤المستخدم ⇠* ["..data.first_name_.."](T.me/"..UserName..")\n"
local keyboard = {}
...
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_, result.id_)
tdcli_function ({ID = "GetUser",user_id_ = result.id_},function(arg,data) 
local UserName = (data.username_ or "HAWAK_Source")
local NameUserr = "\n*◊￤المستخدم ⇠* ["..data.first_name_.."](T.me/"..UserName..")\n"
local keyboard = {}
...
database:sadd(bot_id.."HAWAK:Muted:User"..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
local UserName = (data.username_ or "HAWAK_Source")
local NameUserr = "\n*◊￤المستخدم ⇠* ["..data.first_name_.."](T.me/"..UserName..")\n"
local keyboard = {}
...
function Function_HAWAK(extra, result, success)
database:srem(bot_id.."HAWAK:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_HAWAK(extra, result, success)
if result.id_ then
database:srem(bot_id.."HAWAK:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."HAWAK:Muted:User"..msg.chat_id_, userid)
...
database:set(bot_id..'HAWAK:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","◊￤تم قفـل الفارسيه")  
end
if text and database:get(bot_id..'HAWAK:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'HAWAK:lock:Fshar'..msg.chat_id_) 
...
if text and database:get(bot_id..'HAWAK:lock:Fshar'..msg.chat_id_) and not Constructor(msg) then 
...
database:set(bot_id..'HAWAK:lock:Engilsh'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","*◊￤تم قفل الانكليزيه*")  
end
if text and database:get(bot_id..'HAWAK:lock:Engilsh'..msg.chat_id_) and not Constructor(msg) then 
...
database:del(bot_id..'HAWAK:lock:Engilsh'..msg.chat_id_) 
...
if database:sismember(bot_id.."HAWAK:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."HAWAK:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."HAWAK:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"◊￤انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"◊￤ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
...
database:setex(bot_id.."HAWAK:Set:PHAWAKvate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "الرابط" then 
...
database:set(bot_id.."HAWAK:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."HAWAK:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."HAWAK:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."HAWAK:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."HAWAK:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."HAWAK:Chek:Welcome"..msg.chat_id_,true) 
...
database:del(bot_id.."HAWAK:Chek:Welcome"..msg.chat_id_) 
...
if Addictive(msg) then
database:del(bot_id.."HAWAK:Get:Welcome:Group"..msg.chat_id_) 
...
database:set(bot_id.."HAWAK:Filter:msg",msg.chat_id_)
tdcli_function ({ID = "GetUser",user_id_ = bot_id},function(arg,data) 
...
local listtext = database:smembers(bot_id.."HAWAK:List:Filter:text"..msg.chat_id_)  
for k,v in pairs(listtext) do  
database:srem(bot_id.."HAWAK:List:Filter:text"..msg.chat_id_,v)  
end  
local listAnimation = database:smembers(bot_id.."HAWAK:List:Filter:Animation"..msg.chat_id_)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."HAWAK:List:Filter:Animation"..msg.chat_id_,v)  
end  
local listSticker = database:smembers(bot_id.."HAWAK:List:Filter:Sticker"..msg.chat_id_)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."HAWAK:List:Filter:Sticker"..msg.chat_id_,v)  
end  
local listPhoto = database:smembers(bot_id.."HAWAK:List:Filter:Photo"..msg.chat_id_)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."HAWAK:List:Filter:Photo"..msg.chat_id_,v)  
end  
...
database:set(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"*◊￤تم منع الكلمه بنجاح*")  
database:del(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."HAWAK:List:Filter:text"..msg.chat_id_,text)  
return false 
end  
end
...
database:del(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."HAWAK:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."HAWAK:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."HAWAK:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false 
end  
end
...
database:set(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false 
end
if text then 
local test = database:get(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء منعها ")  
database:del(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."HAWAK:List:Filter:text"..msg.chat_id_,text)  
return false
end  
end
if msg.content_.ID == 'MessageAnimation' then    
local onte = database:get(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if onte and onte == "reppp" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء منع المتحركه بنجاح ")  
database:del(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."HAWAK:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessageSticker' then    
local Stic = database:get(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if Stic and Stic == "reppp" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء منع الملصق بنجاح ")  
database:del(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."HAWAK:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessagePhoto' then    
local hoto = database:get(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if hoto and hoto == "reppp" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء منع الصوره بنجاح ")  
database:del(bot_id.."HAWAK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."HAWAK:List:Filter:Photo"..msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false
end  
end
...
if database:get(bot_id.."HAWAK:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "◊￤تم الغاء حفظ القوانين") 
database:del(bot_id.."HAWAK:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."HAWAK:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."HAWAK:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."HAWAK:Set:Rules:Group"..msg.chat_id_) 
end
end
...
local Set_Rules = database:get(bot_id.."HAWAK:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_.."")
t = "*◊￤قائمه الاوامر المضافه  *\n*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_)
end
...
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"ا")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"تفع")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"رد")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":ت","تثبيت")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"ت")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"تك")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":حذ","حذف رد")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"حذ")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"رس")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"سح")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"ر")
database:set(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
database:sadd(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,"غ")
...
database:set(bot_id.."HAWAK:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
if Constructor(msg) then
database:set(bot_id.."HAWAK:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
function Function_HAWAK(extra, result, success)
database:sadd(bot_id.."HAWAK:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."HAWAK:MN:TF"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."HAWAK:MN:TF"..msg.chat_id_, userid)
...
function Function_HAWAK(extra, result, success)
database:srem(bot_id.."HAWAK:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
function Function_HAWAK(extra, result, success)
if result.id_ then
database:srem(bot_id.."HAWAK:MN:TF"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."HAWAK:MN:TF"..msg.chat_id_, userid)
...
local list = database:smembers(bot_id.."HAWAK:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."HAWAK:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
database:del(bot_id.."HAWAK:MN:TF"..msg.chat_id_)
...
local list = database:smembers(bot_id.."HAWAK:MN:TF"..msg.chat_id_)
t = "\n◊￤قائمة المنظفين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."HAWAK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."HAWAK:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."HAWAK:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."HAWAK:Coomds"..msg.chat_id_)
end
...
database:set(bot_id.."HAWAK:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."HAWAK:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."HAWAK:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."HAWAK:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "◊￤تم مسح الصلاحيه ") 
end
if database:get(bot_id.."HAWAK:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"◊￤تم الغاء الامر ") 
database:del(bot_id.."HAWAK:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."HAWAK:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."HAWAK:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."HAWAK:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◊￤تم تغير رد المطور الى ⇠ "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."HAWAK:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◊￤تم تغير رد المنشئ الاساسي الى ⇠ "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."HAWAK:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◊￤تم تغير رد المنشئ الى ⇠ "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."HAWAK:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"◊￤تم تغير رد المدير الى ⇠ "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."HAWAK:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◊￤تم تغير رد الادمن الى ⇠ "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."HAWAK:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◊￤تم تغير رد المميز الى ⇠ "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."HAWAK:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◊￤تم تغير رد العضو الى ⇠ "..Teext)
end

if text == ("مسح الرتب") and BasicConstructor(msg) then
send(msg.chat_id_, msg.id_,"◊￤تم مسح ردود الرتب بنجاح ")
database:del(bot_id.."HAWAK:Sudo:Rd"..msg.chat_id_)
database:del(bot_id.."HAWAK:BasicConstructor:Rd"..msg.chat_id_)
database:del(bot_id.."HAWAK:Constructor:Rd"..msg.chat_id_)
database:del(bot_id.."HAWAK:Manager:Rd"..msg.chat_id_) 
database:del(bot_id.."HAWAK:Mod:Rd"..msg.chat_id_)
database:del(bot_id.."HAWAK:Special:Rd"..msg.chat_id_)
database:del(bot_id.."HAWAK:Memp:Rd"..msg.chat_id_)
end
if text == ("مسح ردود المدير") and BasicConstructor(msg) then
local list = database:smembers(bot_id.."HAWAK:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."HAWAK:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."HAWAK:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."HAWAK:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."HAWAK:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."HAWAK:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."HAWAK:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."HAWAK:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."HAWAK:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."HAWAK:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."HAWAK:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه 🎭"
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق ◊￤"
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ✉"
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره ◊￤"
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف ◊￤"
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") ⇠ {"..db.."}\n"
end
...
local t = ' \n◊￤تم تفعيل المتحركه'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:gif:HAWAK'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Owner(msg) then
local t = '  \n◊￤تم تعطيل متحركه'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:gif:HAWAK'..msg.chat_id_,true)  
end
if text == "متحركه" and not database:get(bot_id..'HAWAK:gif:HAWAK'..msg.chat_id_) then
local url,res = https.request('https://evzxar.ml/HAWAK.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.HAWAK ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐇𝐀𝐖𝐀𝐊 TEαM .',url="t.me/lllEll2"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token ..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/GifDavid/'..HAWAKsong ..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source HAWAK     --
if text == "تفعيل ميمز" and Owner(msg)  or text == "تفعيل الميمز" and Owner(msg)  then
local t = ' \n◊￤تم تفعيل الميمز'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:memz:HAWAK'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Owner(msg)  or text == "تعطيل الميمز" and Owner(msg)  then
local t= ' \n◊￤تم تعطيل الميمز'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:memz:HAWAK'..msg.chat_id_,true)  
end
if text == "ميمز" and not database:get(bot_id..'HAWAK:memz:HAWAK'..msg.chat_id_)  then
local url,res = https.request('https://evzxar.ml/HAWAK.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.HAWAK ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token ..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzDavid/'..HAWAKsong ..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
return false
end
hson = {": تُمۅٛتہ ڪٰٖݪ ﺎݪاغـَﭑنيہ ۅٛيَحٰـَݪاݪيہ صُۅٛتڪٰٖك .",": ﺎݪـَقاڼۉڼ ࢪَقـَم ١٢٦",": ۅٛاݪيفࢪجۿﭑ صَۅٛتڪٰٖك ،",": عٰـَﭑيفنِيہٰ ࢦِـيݪَ بݪاَ ڪٰٖمࢪ .","نضِݛۿہ‌َٖ منڪ ټݽٖۅهۤۃ ؏َـيونۿمہ‌َٖ ڪٰٖـلهم!","ټرىٰ ﭑݪنضراټ ۿمَ ڪِٰلمات يسمِع صوتهِا ﭑݪيفهم .",": ۅٛڪٰٖݪڪٰٖم صَࢪتۅٛ ضَـٰدييہِ .",": خَنڪٰٖۿهہ !",};
sendhson = hson[math.random(#hson)]
HAWAKsong = math.random(2,1201); 
...
local t = ' \n*◊￤تم تفعيل اغنيه*'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:aaqq:HAWAK'..msg.chat_id_) 
end
if text == "تعطيل اغنيه" and Owner(msg)  then
local t = ' \n*◊￤تم تعطيل اغنيه*'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:aaqq:HAWAK'..msg.chat_id_,true)  
end
if text == "اغنيه" and not database:get(bot_id..'HAWAK:aaqq:HAWAK'..msg.chat_id_)  then
local url,res = https.request('https://evzxar.ml/HAWAK.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.HAWAK ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token ..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/DavidMp3/'..HAWAKsong ..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source HAWAK     --
if text == "تفعيل شعر" and Owner(msg)  then
local t = ' \n◊￤تم تفعيل شعر'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:sher'..msg.chat_id_) 
end
if text == "تعطيل شعر" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل شعر'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:sher'..msg.chat_id_,true)  
end
if text == "شعر" and not database:get(bot_id..'HAWAK:sher'..msg.chat_id_) then
HAWAKsong = math.random(2,11);
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/HAWAKsher/'..HAWAKsong..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source HAWAK     --
if text == "تفعيل غنيلي" and Owner(msg) then
local t = ' \n◊￤تم تفعيل غنيلي'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:Audios:HAWAK'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل غنيلي'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:Audios:HAWAK'..msg.chat_id_,true)  
end
if text == "غنيلي" and not database:get(bot_id..'HAWAK:Audios:HAWAK'..msg.chat_id_)  then
local url,res = https.request('https://evzxar.ml/HAWAK.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.HAWAK ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/AudiosDavid/'..HAWAKsong..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source HAWAK     --
if text == "تفعيل ريمكس" and Owner(msg)  or text == "تفعيل الريمكس" and Owner(msg)  then
local t = ' \n◊￤تم تفعيل الريمكس'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:Remix:HAWAK'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Owner(msg)  or text == "تعطيل الريمكس" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل الريمكس'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:Remix:HAWAK'..msg.chat_id_,true)  
end
if text == "ريمكس" and not database:get(bot_id..'HAWAK:Remix:HAWAK'..msg.chat_id_)  then
local url,res = https.request('https://evzxar.ml/HAWAK.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.HAWAK ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token ..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/RemixDavid/'..HAWAKsong ..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source HAWAK     --
if text == "تفعيل صوره" and Owner(msg)  or text == "تفعيل الصوره" and Owner(msg)  then
local t = ' \n◊￤تم تفعيل الصوره'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:Photo:HAWAK'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Owner(msg)  or text == "تعطيل الصوره" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل الصوره'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:Photo:HAWAK'..msg.chat_id_,true)  
end
if text == "صوره" and not database:get(bot_id..'HAWAK:Photo:HAWAK'..msg.chat_id_)  then
local url,res = https.request('https://evzxar.ml/HAWAK.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.HAWAK ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PhotosDavid/'..HAWAKsong ..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
return false
end
hson = {": تُمۅٛتہ ڪٰٖݪ ﺎݪاغـَﭑنيہ ۅٛيَحٰـَݪاݪيہ صُۅٛتڪٰٖك .",": ﺎݪـَقاڼۉڼ ࢪَقـَم ١٢٦",": ۅٛاݪيفࢪجۿﭑ صَۅٛتڪٰٖك ،",": عٰـَﭑيفنِيہٰ ࢦِـيݪَ بݪاَ ڪٰٖمࢪ .","نضِݛۿہ‌َٖ منڪ ټݽٖۅهۤۃ ؏َـيونۿمہ‌َٖ ڪٰٖـلهم!","ټرىٰ ﭑݪنضراټ ۿمَ ڪِٰلمات يسمِع صوتهِا ﭑݪيفهم .",": ۅٛڪٰٖݪڪٰٖم صَࢪتۅٛ ضَـٰدييہِ .",": خَنڪٰٖۿهہ !",};
sendhson = hson[math.random(#hson)]
HAWAKsong = math.random(4,1171); 
...
local t = ' \n◊￤تم تفعيل الانمي'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:Anime:HAWAK'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Owner(msg)  or text == "تعطيل الانمي" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل الانمي'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:Anime:HAWAK'..msg.chat_id_,true)  
end
if text == "انمي" and not database:get(bot_id..'HAWAK:Anime:HAWAK'..msg.chat_id_)  then
local url,res = https.request('https://evzxar.ml/HAWAK.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.HAWAK ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token ..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AnimeDavid/'..HAWAKsong ..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source HAWAK     --
if text == "تفعيل فلم" and Owner(msg)  then
local t = ' \n◊￤تم تفعيل الافلام'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:Movies:HAWAK'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل الافلام'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:Movies:HAWAK'..msg.chat_id_,true)  
end
if text == "فلم" and not database:get(bot_id..'HAWAK:Movies:HAWAK'..msg.chat_id_)  then
local url,res = https.request('https://evzxar.ml/HAWAK.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.HAWAK ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token ..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MoviesDavid/'..HAWAKsong ..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source HAWAK     --
if text == "تفعيل مسلسل" and Owner(msg)  then
local t = ' \n◊￤تم تفعيل المسلسلات'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:Series:HAWAK'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل المسلسلات'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:Series:HAWAK'..msg.chat_id_,true)  
end
if text == "مسلسل" and not database:get(bot_id..'HAWAK:Series:HAWAK'..msg.chat_id_)  then
local url,res = https.request('https://evzxar.ml/HAWAK.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.HAWAK ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token ..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SeriesDavid/'..HAWAKsong ..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "تفعيل كول" and Owner(msg)  then
local t = ' \n◊￤تم تفعيل كول'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'HAWAK:kol'..msg.chat_id_) 
end
if text == "تعطيل كول" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل كول'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'HAWAK:kol'..msg.chat_id_,true)  
end
if text and text:match("^كول (.*)$") and not database:get(bot_id..'HAWAK:kol'..msg.chat_id_)  then
...
local test = database:get(bot_id.."HAWAK:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."HAWAK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."HAWAK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."HAWAK:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."HAWAK:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."HAWAK:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."HAWAK:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."HAWAK:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."HAWAK:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."HAWAK:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."HAWAK:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."HAWAK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
database:set(bot_id.."HAWAK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."HAWAK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '◊￤الان ارسل الرد الذي تريد اضافته \n◊￤قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n◊￤يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."HAWAK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."HAWAK:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."HAWAK:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."HAWAK:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."HAWAK:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."HAWAK:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."HAWAK:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."HAWAK:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."HAWAK:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."HAWAK:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."HAWAK:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."HAWAK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."HAWAK:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."HAWAK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."HAWAK:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."HAWAK:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'HAWAK:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."HAWAK:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."HAWAK:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."HAWAK:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."HAWAK:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."HAWAK:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."HAWAK:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."HAWAK:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."HAWAK:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'HAWAK:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'HAWAK:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_,'['..Text..']')
database:sadd(bot_id.."HAWAK:Spam:Group"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevHAWAK(msg) then 
local list = database:smembers(bot_id.."HAWAK:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."HAWAK:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."HAWAK:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."HAWAK:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."HAWAK:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."HAWAK:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."HAWAK:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."HAWAK:Add:Rd:Sudo:File"..v)
database:del(bot_id.."HAWAK:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."HAWAK:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"◊￤تم ازالة ردود المطور")
end
if text == ("ردود المطور") and DevHAWAK(msg) then 
local list = database:smembers(bot_id.."HAWAK:List:Rd:Sudo")
text = "\n◊￤قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if database:get(bot_id.."HAWAK:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif database:get(bot_id.."HAWAK:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."HAWAK:Add:Rd:Sudo:stekr"..v) then
db = "ملصق ◊￤"
elseif database:get(bot_id.."HAWAK:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif database:get(bot_id.."HAWAK:Add:Rd:Sudo:Photo"..v) then
db = "صوره ◊￤"
elseif database:get(bot_id.."HAWAK:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."HAWAK:Add:Rd:Sudo:File"..v) then
db = "ملف ◊￤"
elseif database:get(bot_id.."HAWAK:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") ⇠ {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."HAWAK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."HAWAK:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."HAWAK:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."HAWAK:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."HAWAK:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."HAWAK:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."HAWAK:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."HAWAK:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."HAWAK:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"◊￤تم حفظ الرد في المجموعة")
return false  
end  
...
if text == "اضف رد للكل" and DevHAWAK(msg) then 
send(msg.chat_id_, msg.id_,"◊￤الان ارسل الرد الذي تريد وضعة")
database:set(bot_id.."HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevHAWAK(msg) then 
send(msg.chat_id_, msg.id_,"◊￤الان ارسل الرد الذي تريد حذفة")
database:set(bot_id.."HAWAK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '◊￤الان ارسل الرد الذي تريد اضافته \n◊￤قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n◊￤يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."HAWAK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."HAWAK:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."HAWAK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◊￤تم ازالة الرد من قائمه ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'HAWAK:'..v..text)
end
database:del(bot_id.."HAWAK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."HAWAK:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."HAWAK:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'HAWAK:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."HAWAK:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."HAWAK:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."HAWAK:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."HAWAK:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."HAWAK:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."HAWAK:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."HAWAK:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."HAWAK:Add:Rd:Sudo:Audio"..text)
...
function Function_HAWAK(extra, result, success)
if DevHAWAKe(result.sender_user_id_)  then
send(msg.chat_id_, msg.id_,"◊￤لا تستطيع تنزيل مطور البوت او السورس")
return false 
end
if database:sismember(bot_id.."HAWAK:Sudo:User", result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."HAWAK:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."HAWAK:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."HAWAK:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."HAWAK:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
if DevHAWAKe(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."HAWAK:Sudo:User", result.sender_user_id_)
database:srem(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."HAWAK:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Special:User"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."HAWAK:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."HAWAK:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Constructor"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."HAWAK:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Manager"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."HAWAK:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."HAWAK:Special:User"..msg.chat_id_, result.sender_user_id_)
end
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, Function_HAWAK, nil)
end
...
tagname = tagname:gsub("]","")
tagname = tagname:gsub("[[]","")
t = t.."*"..x.." ↝* [@"..database:get(bot_id.."HAWAK:User:Name"..v.user_id_).."]\n"
end
if k == 0 then
send(msg.chat_id_,msg.id_,t)
end
...
if database:get(bot_id.."HAWAK:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"◊￤انتظر دقيقه من فضلك")
end
database:setex(bot_id.."HAWAK:admin:Time"..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id.."HAWAK:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."HAWAK:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
...
database:set(bot_id.."HAWAK:Kick:Me"..msg.chat_id_,true)  
Text = "\n◊￤تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_HAWAK(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."HAWAK:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."HAWAK:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."HAWAK:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_HAWAK(extra, result, success)
if database:sismember(bot_id.."HAWAK:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."HAWAK:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."HAWAK:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."HAWAK:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."HAWAK:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
local UserName = (b.username_ or "HAWAK_Source")
...
if text == "تفعيل المغادره" and DevHAWAK(msg) then   
database:del(bot_id.."HAWAK:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"◊￤تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevHAWAK(msg) then  
database:set(bot_id.."HAWAK:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "◊￤تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."HAWAK:Name:Bot") or "هواك") then
Namebot = (database:get(bot_id.."HAWAK:Name:Bot") or "هواك")
local namebot = {
'لابسك لتلح',
'لاتوصخ اسمي',
'هاقلبي؟ كول',
...
if DevHAWAK(msg) then
database:setex(bot_id.."HAWAK:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."HAWAK:Status:Bc") and not DevHAWAK(msg) then 
send(msg.chat_id_, msg.id_,"◊￤الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."HAWAK:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."HAWAK:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◊￤ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n◊￤للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."HAWAK:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◊￤ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n◊￤للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."HAWAK:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."HAWAK:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◊￤ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevHAWAK(msg) then  
database:del(bot_id.."HAWAK:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n◊￤تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevHAWAK(msg) then  
database:set(bot_id.."HAWAK:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n◊￤تم تعطيل الاذاعه") 
return false
end 

if text == "/lock" and Addictive(msg) then    
if database:get(bot_id.."HAWAK:lockpin"..msg.chat_id_) then    
lock_pin = "{✅}"
else 
lock_pin = "{❌}"    
end
if database:get(bot_id.."HAWAK:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "{✅}"
else 
lock_tagservr = "{❌}"    
end
if database:get(bot_id.."HAWAK:Lock:text"..msg.chat_id_) then    
lock_text = "{✅}"
else 
lock_text = "{❌}"    
end
...
if database:get(bot_id.."HAWAK:Lock:edit"..msg.chat_id_) then    
lock_edit = "{✅}"
else 
lock_edit = "{❌}"    
end
...
if database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "{❌}"     
end
...
if database:get(bot_id.."HAWAK:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "{✅}"
elseif database:get(bot_id.."HAWAK:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."HAWAK:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."HAWAK:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "{❌}"    
end
if database:get(bot_id.."HAWAK:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "{✅}"
elseif database:get(bot_id.."HAWAK:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."HAWAK:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."HAWAK:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "{❌}"    
end
if database:get(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "{✅}"
elseif database:get(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "{❌}"    
end
if database:get(bot_id.."HAWAK:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "{✅}"
elseif database:get(bot_id.."HAWAK:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."HAWAK:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."HAWAK:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "{❌}"    
end
...
if database:get(bot_id.."HAWAK:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "{✅}"
elseif database:get(bot_id.."HAWAK:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."HAWAK:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "{❌}"    
end
...
if database:get(bot_id.."HAWAK:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "{✅}"
elseif database:get(bot_id.."HAWAK:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."HAWAK:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."HAWAK:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "{❌}"    
end        
if not database:get(bot_id.."HAWAK:Reply:Manager"..msg.chat_id_) then
rdmder = "{✅}"
else
rdmder = "{❌}"
end
if not database:get(bot_id.."HAWAK:Reply:Sudo"..msg.chat_id_) then
rdsudo = "{✅}"
else
rdsudo = "{❌}"
end
if not database:get(bot_id.."HAWAK:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "{✅}"
else
idgp = "{❌}"
end
if not database:get(bot_id.."HAWAK:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "{✅}"
else
idph = "{❌}"
end
if not database:get(bot_id.."HAWAK:Lock:kick"..msg.chat_id_)  then
setadd = "{✅}"
else
setadd = "{❌}"
end
if not database:get(bot_id.."HAWAK:Lock:Add:Bot"..msg.chat_id_)  then
banm = "{✅}"
else
banm = "{❌}"
end
...
Num_Flood = database:hget(bot_id.."HAWAK:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n◊￤ااعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"..
"\n◊￤علامة ال {✅} تعني مفعل"..
...
list ={"lock:HAWAK:kick","lock:user:name","lock:Link","lock:forward","lock:Sticker","lock:Animation","lock:Video","lock:Fshar","Bot:Id:Photo","lock:Audio","lock:vico","lock:Document","lock:Unsupported","lock:Markdaun","lock:Contact","lock:Spam"}
for i,lock in pairs(list) do 
...
database:del(bot_id..'HAWAK:Lock:ID:Bot'..msg.chat_id_) 
...
database:set(bot_id..'HAWAK:Lock:ID:Bot'..msg.chat_id_,true) 
...
database:del(bot_id..'HAWAK:Lock:ID:Bot:Photo'..msg.chat_id_) 
...
database:set(bot_id..'HAWAK:Lock:ID:Bot:Photo'..msg.chat_id_,true) 
...
database:setex(bot_id.."HAWAK:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
◊￤ارسل الان النص
◊￤يمكنك اضافه :
◊￤#username > اسم المستخدم
...
database:set(bot_id.."HAWAK:Klesh:Id:Bot"..msg.chat_id_,Text_Rand)
send(msg.chat_id_, msg.id_,'◊￤تم تغير الايدي ارسل ايدي لرؤيته')
end
if text == 'حذف الايدي' or text == 'مسح الايدي' then
if Owner(msg) then
database:del(bot_id.."HAWAK:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '◊￤تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."HAWAK:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"◊￤تم الغاء تعين الايدي") 
database:del(bot_id.."HAWAK:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."HAWAK:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."HAWAK:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'◊￤تم تعين الايدي')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'HAWAK:Lock:ID:Bot'..msg.chat_id_) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local NumMsg = database:get(bot_id..'HAWAK:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."HAWAK:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'HAWAK:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."HAWAK:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."HAWAK:Klesh:Id:Bot"..msg.chat_id_) or database:get(bot_id.."HAWAK:KleshIDALLBOT")
if not database:get(bot_id..'HAWAK:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
if not database:get(bot_id..'HAWAK:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'HAWAK:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end


if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and not database:get(bot_id..'HAWAK:Lock:ID:Bot'..msg.chat_id_) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local Id = data.id_
local NumMsg = database:get(bot_id..'HAWAK:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'HAWAK:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."HAWAK:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."HAWAK:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^كشف @(.*)$")  and not database:get(bot_id..'HAWAK:Lock:ID:Bot'..msg.chat_id_) then
...
if database:get(bot_id.."HAWAK:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."HAWAK:Set:Sma"..msg.chat_id_)
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","??","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","🍵","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","??","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","??","🎬","🎨","🎭","🎪","🎟","◊￤","🎗","🏵","◊￤","🏆","🥌","🛷","🚗","🚌","🏎","🚓","??","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","◊￤","📍","📓","📗","◊￤","📅","📪","◊￤","◊￤","📭","⏰","📺","🎚","☎️","◊￤"}
SM = Random[math.random(#Random)]
database:set(bot_id.."HAWAK:Random:Sm"..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,"◊￤اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
end
if text == ""..(database:get(bot_id.."HAWAK:Random:Sm"..msg.chat_id_) or "").."" and not database:get(bot_id.."HAWAK:Set:Sma"..msg.chat_id_) then
if not database:get(bot_id.."HAWAK:Set:Sma"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"◊￤الف مبروك لقد فزت \n◊￤للعب مره اخره ارسل ~{ سمايل , سمايلات }")
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."HAWAK:Set:Sma"..msg.chat_id_,true)
return false
end 
if text == "الاسرع" or text == "ترتيب" then
if database:get(bot_id.."HAWAK:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."HAWAK:Speed:Tr"..msg.chat_id_)
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
database:set(bot_id.."HAWAK:Klam:Speed"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."HAWAK:Klam:Speed"..msg.chat_id_) or "").."" and not database:get(bot_id.."HAWAK:Speed:Tr"..msg.chat_id_) then
if not database:get(bot_id.."HAWAK:Speed:Tr"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"◊￤الف مبروك لقد فزت \n◊￤للعب مره اخره ارسل ~{ الاسرع , ترتيب }")
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."HAWAK:Speed:Tr"..msg.chat_id_,true)
end 
...
if database:get(bot_id.."HAWAK:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."HAWAK:Set:Hzora"..msg.chat_id_)
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","غلط","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
name = Hzora[math.random(#Hzora)]
database:set(bot_id.."HAWAK:Klam:Hzor"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."HAWAK:Klam:Hzor"..msg.chat_id_) or "").."" and not database:get(bot_id.."HAWAK:Set:Hzora"..msg.chat_id_) then
if not database:get(bot_id.."HAWAK:Set:Hzora"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"◊￤الف مبروك لقد فزت \n◊￤للعب مره اخره ارسل ~{ حزوره }")
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."HAWAK:Set:Hzora"..msg.chat_id_,true)
end 
...
if database:get(bot_id.."HAWAK:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."HAWAK:Set:Maany"..msg.chat_id_)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
database:set(bot_id.."HAWAK:Maany"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."HAWAK:Maany"..msg.chat_id_) or "").."" and not database:get(bot_id.."HAWAK:Set:Maany"..msg.chat_id_) then
if not database:get(bot_id.."HAWAK:Set:Maany"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"◊￤الف مبروك لقد فزت \n◊￤للعب مره اخره ارسل ~{ معاني }")
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."HAWAK:Set:Maany"..msg.chat_id_,true)
end 
...
if database:get(bot_id.."HAWAK:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."HAWAK:Set:Aks"..msg.chat_id_)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
database:set(bot_id.."HAWAK:Set:Aks:Game"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."HAWAK:Set:Aks:Game"..msg.chat_id_) or "").."" and not database:get(bot_id.."HAWAK:Set:Aks"..msg.chat_id_) then
if not database:get(bot_id.."HAWAK:Set:Aks"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"◊￤الف مبروك لقد فزت \n◊￤للعب مره اخره ارسل ~{ العكس }")
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."HAWAK:Set:Aks"..msg.chat_id_,true)
end 

if database:get(bot_id.."HAWAK:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
send(msg.chat_id_, msg.id_,"◊￤عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
local GETNUM = database:get(bot_id.."HAWAK:GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."HAWAK:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."HAWAK:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,"◊￤مبروك فزت ويانه وخمنت الرقم الصحيح\n◊￤تم اضافة { 5 } من النقاط \n")
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:incrby(bot_id.."HAWAK:SADD:NUM"..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(database:get(bot_id.."HAWAK:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)) >= 3 then
database:del(bot_id.."HAWAK:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."HAWAK:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
database:set(bot_id.."HAWAK:GAMES:NUM"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,"\n◊￤اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".."◊￤ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."◊￤سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
database:setex(bot_id.."HAWAK:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end

if database:get(bot_id.."HAWAK:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
send(msg.chat_id_, msg.id_,"◊￤عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."HAWAK:Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."HAWAK:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"◊￤مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n🎊︙لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."HAWAK:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if database:get(bot_id.."HAWAK:Lock:Games"..msg.chat_id_) then   
Num = math.random(1,6)
database:set(bot_id.."HAWAK:Games:Bat"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
database:setex(bot_id.."HAWAK:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
...
database:del(bot_id.."HAWAK:Set:Moktlf:Bot"..msg.chat_id_)
database:set(bot_id.."HAWAK::Set:Moktlf"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."HAWAK::Set:Moktlf"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."HAWAK:Set:Moktlf:Bot"..msg.chat_id_) then 
database:del(bot_id.."HAWAK::Set:Moktlf"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"◊￤الف مبروك لقد فزت \n◊￤للعب مره اخره ارسل ~{ المختلف }")
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."HAWAK:Set:Moktlf:Bot"..msg.chat_id_,true)
end
if text == "امثله" then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
database:set(bot_id.."HAWAK:Set:Amth"..msg.chat_id_,name)
database:del(bot_id.."HAWAK:Set:Amth:Bot"..msg.chat_id_)
...
if text == ""..(database:get(bot_id.."HAWAK:Set:Amth"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."HAWAK:Set:Amth:Bot"..msg.chat_id_) then 
database:del(bot_id.."HAWAK:Set:Amth"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"◊￤الف مبروك لقد فزت \n◊￤للعب مره اخره ارسل ~{ امثله }")
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."HAWAK:Set:Amth:Bot"..msg.chat_id_,true)
end
...
database:del(bot_id.."HAWAK:Lock:Games"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"\n◊￤تم تعطيل الالعاب") 
end
...
database:set(bot_id.."HAWAK:Lock:Games"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"\n◊￤تم تفعيل الالعاب") 
end
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'HAWAK:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '◊￤عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'HAWAK:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
if text == 'جهاتي' then
local addmem = database:get(bot_id.."HAWAK:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '◊￤عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'HAWAK:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
local Num = database:get(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
if Num == 0 then 
...
if tonumber(database:get(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,"◊￤ليس لديك جواهر من الالعاب \n◊￤اذا كنت تريد ربح الجواهر \n◊￤ارسل الالعاب وابدأ اللعب ! ") 
else
local NUM_GAMES = database:get(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,"\n◊￤ليس لديك جواهر بهاذا العدد \n◊￤لزيادة مجوهراتك في اللعبه \n◊￤ارسل الالعاب وابدأ اللعب !") 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id.."HAWAK:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
if database:get(bot_id.."HAWAK:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."HAWAK:id:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "◊￤تم الغاء الامر ") 
database:del(bot_id.."HAWAK:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."HAWAK:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."HAWAK:id:user"..msg.chat_id_)  
database:del(bot_id.."HAWAK:Msg_User"..msg.chat_id_..":"..msg.sender_user_id_) 
database:incrby(bot_id.."HAWAK:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
send(msg.chat_id_, msg.id_,"◊￤تم اضافة له {"..numadded.."} من الرسائل")  
end
if database:get(bot_id.."HAWAK:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."HAWAK:idgem:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "◊￤تم الغاء الامر ") 
database:del(bot_id.."HAWAK:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."HAWAK:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."HAWAK:idgem:user"..msg.chat_id_)  
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..iduserr,numadded)  
...
database:set(bot_id.."HAWAK:id:user"..msg.chat_id_,Hussain)  
database:setex(bot_id.."HAWAK:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:set(bot_id.."HAWAK:idgem:user"..msg.chat_id_,Hussain)  
database:setex(bot_id.."HAWAK:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:incrby(bot_id.."HAWAK:Add:Num"..msg.chat_id_..result.sender_user_id_,Num)  
...
function reply(extra, result, success)
database:del(bot_id.."HAWAK:Msg_User"..msg.chat_id_..":"..result.sender_user_id_) 
database:incrby(bot_id.."HAWAK:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and DevHAWAK(msg) then
local pv = database:smembers(bot_id..'HAWAK:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'HAWAK:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and DevHAWAK(msg) then
...
send(msg.chat_id_, msg.id_,'*◊￤عدد المجموعات الان ~ '..#group..' مجموعه '..HAWAK..''..Hussain..'\n◊￤اصبح عدد المجموعات الان ~ '..sendok..' مجموعات*\n')   
end
end
end,nil)
end
...
if text == "تحديث السورس" and DevHAWAK(msg) or text == "تحديث" and DevHAWAK(msg) then  
...
if text == "تحديث الملفات" and DevHAWAK(msg) then
dofile("HAWAK.lua")  
send(msg.chat_id_, msg.id_, "◊￤تم تحديث ملفات البوت")
return false
end
if text == 'تحديث هواك' and DevHAWAK(msg) then
download_to_file('https://raw.githubusercontent.com/SourceHawak/HAWAK/master/HAWAK.lua','HAWAK.lua') 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n◊￤العضو ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'HAWAK')..') '
status  = '\n◊￤تم تغيير لقب '..namess..''
send(msg.chat_id_, msg.id_, usertext..status)
...
usertext = '\n◊￤العضو ⇠ ['..result.title_..'](t.me/'..(username or 'HAWAK_Source')..')'
...
tdcli_function ({ID = "SearchPublicChat",username_ = username[2]}, Function_HAWAK, nil)
return false
end
...
local Texti = '*\n◊￤اعدادات المجموعه \n◊￤علامة ال {✅} تعني مقفول\n◊￤علامة ال {❌} تعني مفتوح*'
local mute_text = (database:get(bot_id.."HAWAK:Lock:text"..msg.chat_id_)  or '{❌}')
local mute_text1 = mute_text:gsub('del', '{✅}')
local lock_bots = (database:get(bot_id.."HAWAK:Lock:Bot:kick"..msg.chat_id_) or '{❌}')
local lock_bots1 = lock_bots:gsub('kick', '{✅}')
local mute_tgservice = (database:get(bot_id.."HAWAK:Lock:tagservr"..msg.chat_id_) or '{❌}')
local mute_tgservice1 = mute_tgservice:gsub('true', '{✅}')
local lock_edit = (database:get(bot_id.."HAWAK:Lock:edit"..msg.chat_id_) or '{❌}')
local lock_edit1 = lock_edit:gsub('true', '{✅}')
local lock_link = (database:get(bot_id.."HAWAK:Lock:Link"..msg.chat_id_) or '{❌}')
local lock_link1 = lock_link:gsub('del', '{✅}')
local lock_username = (database:get(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_) or '{❌}')
local lock_username1 = lock_username:gsub('del', '{✅}')
local lock_tag = (database:get(bot_id.."HAWAK:Lock:hashtak"..msg.chat_id_) or '{❌}')
local lock_tag1 = lock_tag:gsub('del', '{✅}')
local mute_sticker = (database:get(bot_id.."HAWAK:Lock:Sticker"..msg.chat_id_) or '{❌}')
local mute_sticker1 = mute_sticker:gsub('del', '{✅}')
local mute_gif = (database:get(bot_id.."HAWAK:Lock:Animation"..msg.chat_id_) or '{❌}')
local mute_gif1 = mute_gif:gsub('del', '{✅}')
local mute_video = (database:get(bot_id.."HAWAK:Lock:Video"..msg.chat_id_) or '{❌}')
local mute_video1 = mute_video:gsub('del', '{✅}')
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = 'تفعيل الرابط', callback_data=msg.sender_user_id_.."/HAWAK:Link_Group"},{text = 'تعطيل الرابط', callback_data=msg.sender_user_id_.."/unHAWAK:Link_Group"},
},
{
{text = 'تفعيل الترحيب', callback_data=msg.sender_user_id_.."/HAWAK:Chek:Welcome"},{text = 'تعطيل الترحيب', callback_data=msg.sender_user_id_.."/unHAWAK:Chek:Welcome"},
},
{
{text = 'تفعيل ردود المدير', callback_data=msg.sender_user_id_.."/HAWAK:Reply:Manager"},{text = 'تعطيل ردود المدير', callback_data=msg.sender_user_id_.."/unHAWAK:Reply:Manager"},
},
{
{text = 'تفعيل ردود المطور', callback_data=msg.sender_user_id_.."/HAWAK:Reply:Sudo"},{text = 'تعطيل ردود المطور', callback_data=msg.sender_user_id_.."/unHAWAK:Reply:Sudo"},
},
{
{text = 'تفعيل اطردني', callback_data=msg.sender_user_id_.."/HAWAK:Kick:Me"},{text = 'تعطيل اطردني', callback_data=msg.sender_user_id_.."/unHAWAK:Kick:Me"},
},
{
{text = 'تفعيل المغادره', callback_data=msg.sender_user_id_.."/HAWAK:Left:Bot"},{text = 'تعطيل المغادره', callback_data=msg.sender_user_id_.."/unHAWAK:Left:Bot"},
},
{
{text = 'تفعيل الاذاعه', callback_data=msg.sender_user_id_.."/HAWAK:Status:Bc"},{text = 'تعطيل الاذاعه', callback_data=msg.sender_user_id_.."/unHAWAK:Status:Bc"},
},
{
{text = 'تفعيل اوامر التحشيش', callback_data=msg.sender_user_id_.."/HAWAK:Fun_Bots"},{text = 'تعطيل اوامر التحشيش', callback_data=msg.sender_user_id_.."/unHAWAK:Fun_Bots"},
},
{
{text = 'تفعيل الايدي ', callback_data=msg.sender_user_id_.."/HAWAK:Lock:ID:Bot"},{text = 'تعطيل الايدي', callback_data=msg.sender_user_id_.."/unHAWAK:Lock:ID:Bot"},
},
{
{text = 'تفعيل الايدي بالصوره', callback_data=msg.sender_user_id_.."/HAWAK:Lock:ID:Bot:Photo"},{text = 'تعطيل الايدي بالصوره', callback_data=msg.sender_user_id_.."/unHAWAK:Lock:ID:Bot:Photo"},
},
{
...
{
{text = 'تفعيل الالعاب', callback_data=msg.sender_user_id_.."/HAWAK:Lock:Games"},{text = 'تعطيل الالعاب', callback_data=msg.sender_user_id_.."/unHAWAK:Lock:Games"},
},
{
...
{
{text = 'تفعيل للزخرفه', callback_data=msg.sender_user_id_.."/HAWAK:zhrf_Bots"},{text = 'تعطيل الزخرفه', callback_data=msg.sender_user_id_.."/unHAWAK:zhrf_Bots"},
},
{
{text = 'تفعيل الابراج', callback_data=msg.sender_user_id_.."/HAWAK:brj_Bots"},{text = 'تعطيل الابراج', callback_data=msg.sender_user_id_.."/unHAWAK:brj_Bots"},
},
{
{text = 'تفعيل حساب العمر', callback_data=msg.sender_user_id_.."/HAWAK:age_Bots"},{text = 'تعطيل حساب للعمر', callback_data=msg.sender_user_id_.."/unHAWAK:age_Bots"},
},
{
{text = 'تفعيل الافلام', callback_data=msg.sender_user_id_.."/HAWAK:movie_bot"},{text = 'تعطيل الافلام', callback_data=msg.sender_user_id_.."/unHAWAK:movie_bot"},
},
{
{text = 'تفعيل البوت الخدمي', callback_data=msg.sender_user_id_.."/HAWAK:Free:Add:Bots"},{text = 'تعطيل البوت الخدمي', callback_data=msg.sender_user_id_.."/unHAWAK:Free:Add:Bots"},
},
{
{text = 'تفعيل الانستا', callback_data=msg.sender_user_id_.."/HAWAK:insta_bot"},{text = 'تعطيل الانستا', callback_data=msg.sender_user_id_.."/unHAWAK:insta_bot"},
},
...
database:set(bot_id.."HAWAK:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Owner(msg) then
send(msg.chat_id_, msg.id_,'◊￤تم تفعيل الزخرفه')
database:set(bot_id.."HAWAK:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."HAWAK:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."HAWAK:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Owner(msg) then
send(msg.chat_id_, msg.id_,'◊￤تم تفعيل الابراج')
database:set(bot_id.."HAWAK:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."HAWAK:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."HAWAK:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Owner(msg) then
send(msg.chat_id_, msg.id_,'◊￤تم تفعيل حساب العمر')
database:set(bot_id.."HAWAK:age_Bots"..msg.chat_id_,"open")
end
if text == "تعطيل معاني الاسماء" and Owner(msg) then
send(msg.chat_id_, msg.id_, '◊￤تم تعطيل معاني الاسماء')
database:set(bot_id.."HAWAK:mean"..msg.chat_id_,"close")
end
if text == "تفعيل معاني الاسماء" and Owner(msg) then
send(msg.chat_id_, msg.id_,'◊￤تم تفعيل معاني الاسماء')
database:set(bot_id.."HAWAK:mean"..msg.chat_id_,"open")
end
if text and text:match("^معنى الاسم (.*)$") or text and text:match("^معنى اسم (.*)$") and database:get(bot_id.."HAWAK:mean"..msg.chat_id_) == "open" then 
...
if text and text:match("^احسب (.*)$") and database:get(bot_id.."HAWAK:age_Bots"..msg.chat_id_) == "open" then
...
for k,v in pairs(list) do   
NAME = 'HAWAK Chat'
ASAS = database:smembers(bot_id.."HAWAK:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."HAWAK:Constructor"..v)
MDER = database:smembers(bot_id.."HAWAK:Manager"..v)
MOD = database:smembers(bot_id.."HAWAK:Mod:User"..v)
link = database:get(bot_id.."HAWAK:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"HAWAK":"'..NAME..'",'
else
t = t..',"'..v..'":{"HAWAK":"'..NAME..'",'
...
database:set(bot_id.."HAWAK:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_,'◊￤ تم تفعيل الانستا')
database:set(bot_id.."HAWAK:insta_bot"..msg.chat_id_,"open")
end
if database:get(bot_id.."HAWAK:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."HAWAK:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Owner(msg) then
send(msg.chat_id_, msg.id_,'◊￤تم تفعيل الافلام')
database:set(bot_id.."HAWAK:movie_bot"..msg.chat_id_,"open")
end

if text and text:match("^فلم (.*)$") and database:get(bot_id.."HAWAK:movie_bot"..msg.chat_id_) == "open" then
...
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and database:get(bot_id.."HAWAK:Lock:Xn"..msg.chat_id_)=="del" then      
...
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and database:get(bot_id.."HAWAK:Lock:Xn"..msg.chat_id_)=="del" then
...
if text == 'تفعيل البوت الخدمي' and DevHAWAK(msg) then  
database:del(bot_id..'HAWAK:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'◊￤تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevHAWAK(msg) then  
database:set(bot_id..'HAWAK:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'◊￤تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevHAWAK(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'HAWAK:Num:Add:Bot',Num) 
...
local Users = database:scard(bot_id..'HAWAK:UsersBot')  
send(msg.chat_id_, msg.id_,'◊￤احصائيات البوت \n\n◊￤عدد المجموعات *~ '..Groups..'\n◊￤عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه الردود' and DevHAWAK(msg) then
...
listrep = database:smembers(bot_id.."HAWAK:List:Manager"..ide.."")
if k == 1 then
...
if database:get(bot_id.."HAWAK:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..database:get(bot_id.."HAWAK:Add:Rd:Manager:Gif"..v..ide)
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..database:get(bot_id.."HAWAK:Add:Rd:Manager:Vico"..v..ide)
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..database:get(bot_id.."HAWAK:Add:Rd:Manager:Stekrs"..v..ide)
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..database:get(bot_id.."HAWAK:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..database:get(bot_id.."HAWAK:Add:Rd:Manager:Photo"..v..ide) 
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..database:get(bot_id.."HAWAK:Add:Rd:Manager:Video"..v..ide)
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:File"..v..ide) then
db = "File@"..database:get(bot_id.."HAWAK:Add:Rd:Manager:File"..v..ide)
elseif database:get(bot_id.."HAWAK:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..database:get(bot_id.."HAWAK:Add:Rd:Manager:Audio"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Get_Json = Get_Json..'}}'
local File = io.open('./File_Libs/HAWAKReply.json', "w")
File:write(Get_Json)
File:close()
return sendDocument(msg.chat_id_, msg.id_,'./File_Libs/HAWAKReply.json', '')
end
if text == 'رفع نسخه الردود' and msg.reply_to_message_id_ ~= 0 and DevHAWAK(msg) then
...
database:sadd(bot_id.."HAWAK:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
database:set(bot_id.."HAWAK:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
database:set(bot_id.."HAWAK:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
database:set(bot_id.."HAWAK:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
database:set(bot_id.."HAWAK:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
database:set(bot_id.."HAWAK:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
database:set(bot_id.."HAWAK:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
database:set(bot_id.."HAWAK:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
database:set(bot_id.."HAWAK:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
end
end
end
end
...
if text == 'رفع المشتركين' and DevHAWAK(msg) then  
function by_reply(extra, result, success)   
...
database:sadd(bot_id..'HAWAK:UsersBot',v) 
end
...
if text == 'جلب المشتركين' and DevHAWAK(msg) then  
local list = database:smembers(bot_id..'HAWAK:UsersBot')  
local t = '{"users":['  
for k,v in pairs(list) do
if k == 1 then
...
if text == 'جلب نسخه احتياطيه' and DevHAWAK(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'HAWAK Chat'
...
MOD = database:smembers(bot_id.."HAWAK:Mod:User"..v)
link = database:get(bot_id.."HAWAK:Link_Group"..v) or ''
sudo = database:get(bot_id.."HAWAK:Sudo:Rd"..v)
if sudo then
...
pres = database:get(bot_id.."HAWAK:BasicConstructor:Rd"..v)
if pres then
...
cons = database:get(bot_id.."HAWAK:Constructor:Rd"..v)
if cons then
...
mang = database:get(bot_id.."HAWAK:Manager:Rd"..v) 
if mang then
...
admin = database:get(bot_id.."HAWAK:Mod:Rd"..v)
if admin then
...
vipe = database:get(bot_id.."HAWAK:Special:Rd"..v)
if vipe then
...
memp = database:get(bot_id.."HAWAK:Memp:Rd"..v)
if memp then
...
local Text_Dev = database:get(bot_id..'HAWAK:Text_Dev')
if Text_Dev then 
...
if text == 'نقل الاحصائيات' and DevHAWAK(msg) then
local Users = database:smembers('HAWAK:'..bot_id.."userss")
local Groups = database:smembers('HAWAK:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'Chek:Groups',Groups[i])  
end
for i = 1, #Users do
database:sadd(bot_id..'HAWAK:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'◊￤تم نقل : '..#Groups..' كروب\n◊￤تم نقل : '..#Users..' مشترك \n◊￤من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف كليشه المطور' and DevHAWAK(msg) then
database:del(bot_id..'HAWAK:Text_Dev')
send(msg.chat_id_, msg.id_,'◊￤تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevHAWAK(msg) then
database:set(bot_id..'HAWAK:Set:Text_Dev'..msg.chat_id_,true)
send(msg.chat_id_,msg.id_,'*◊￤ارسل الكليشه الان*')
return false
end
if text and database:get(bot_id..'HAWAK:Set:Text_Dev'..msg.chat_id_) then
if text == 'الغاء' then 
database:del(bot_id..'HAWAK:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'◊￤تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'HAWAK:Text_Dev',text)
database:del(bot_id..'HAWAK:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'◊￤تم حفظ كليشة المطور')
return false
end
if text == 'رفع النسخه الاحتياطيه' and DevHAWAK(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
if result.content_.document_ then 
local ID_FILE = result.content_.document_.document_.persistent_id_ 
...
local Text = "\n◊￤يوزر البوت ⇠ "..textee.."\n◊￤اسم البوت ⇠ "..texte.."\n◊￤من سورس ⇠ [𝐇𝐀𝐖𝐀𝐊 TEαM](https://t.me/lllEll2)"
if bo.photos_[0] then
x = {} 
x.inline_keyboard = {
{{text = 'قناه السورس 📢', url="https://t.me/lllEll2"}},
{{text = 'تواصل السورس 💬', url="https://t.me/U41bot"}},
{{text = 'شروحات السورس 📑', url="https://t.me/infoo_HAWAK"}},
}
...
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'مطور السورس' or text == 'اريد بوت تمبلر' or text == 'سورس هواك' or text == 'عجبني البوت' or text == 'منو منصبلك' or text == 'منو مطور السورس' or text == 'اريد انصب بوت' or text == 'سورس هواك' or text == '@lllEll1' then
...
tdcli_function ({ID = "GetUser",user_id_ = 1842536919},function(arg,data) 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = 1842536919,offset_ = 0,limit_ = 1},function(extra,bo,success) 
local Text = "* Dev Name ↬ * ["..data.first_name_.."](T.me/"..data.username_..")\n*Dev User ↬* [@"..data.username_.."]"
if bo.photos_[0] then
x = {} 
x.inline_keyboard = {
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'HAWAK:Num:Add:Bot') or 0) and not DevHAWAK(msg) then
send(msg.chat_id_, msg.id_,'◊￤عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'HAWAK:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'HAWAK:Free:Add:Bots') then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if not database:get(bot_id..'HAWAK:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'HAWAK:Start:Time'..msg.sender_user_id_,60,true)
return false
end
...
local Text = '*◊￤اهلا بك مجددا عزيزي المطور \n◊￤اليك الازرار الخاصه بمتجر سورس هواك فقط اضغط على الامر الذي تريد تنفيذه*'
local keyboard = {
{'متجر الملفات ↝'},
...
local Text = '*◊￤اهلا بك مجددا عزيزي المطور \n◊￤اليك الازرار الخاصه بأوامر الخدمية لسورس هواك فقط اضغط على الامر الذي تريد تنفيذه*'
local keyboard = {
{'الابراج ↝'},
...
keyboard.inline_keyboard = {
{
{text = '𝐇𝐀𝐖𝐀𝐊 TEαM .',url="https://t.me/lllEll2"},
},
{
...
Sf = database:get(bot_id.."HAWAK:Filter:msg")
local list = database:smembers(bot_id.."HAWAK:List:Filter:Photo"..Sf)  
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."HAWAK:List:Filter:text"..sl)
...
local list = database:smembers(bot_id.."HAWAK:List:Filter:Animation"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."HAWAK:List:Filter:Sticker"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
if not DevHAWAK(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."HAWAK:Filter"..msg.sender_user_id_) then
...
if DevHAWAK(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,' ◊￤[تحديثات ﭑݪسورس](https://t.me/infoo_HAWAK) \n ◊￤[قناه ﭑݪسورس](https://t.me/lllEll2)')
end
if text == 'المطور ↝' or text == 'مطور' or text == 'المطورين' then
local Text_Dev = database:get(bot_id..'HAWAK:Text_Dev')
if Text_Dev then 
...
send(msg.chat_id_, msg.id_,'◊￤اصدار سورس* هواك* لديك (*v1.0*) ↝')
end
...
database:set(bot_id..'HAWAK:Ed:DevBots',true) 
end
...
if database:get(bot_id.."HAWAK:Ed:DevBots") then
if text and text:match("^(%d+)$") then
...
A:close()
database:del(bot_id.."HAWAK:Ed:DevBots")
end
end
...
if text == ("قائمة العام ↝") and DevHAWAK(msg) then
local list = database:smembers(bot_id.."HAWAK:GBan:User")
t = "\n◊￤قائمة المحظورين عام \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."HAWAK:User:Name" .. v)
...
if text == 'الملفات' or text == 'الملفات ↝' and DevHAWAK(msg) then
t = '◊￤جميع الملفات : \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
i = 0
for v in io.popen('ls HAWAK_Files'):lines() do
if v:match(".lua$") then
...
if text == "مسح جميع الملفات" or text == 'مسح جميع الملفات ↝' and DevHAWAK(msg) then
os.execute("rm -fr HAWAK_Files/*")
send(msg.chat_id_,msg.id_,"◊￤تم حذف جميع الملفات")
return false
end
if text == "متجر الملفات ↝" or text == 'المتجر' and DevHAWAK(msg) then
if DevHAWAK(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceHawak/files_HAWAK/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n◊￤اهلا بك في متجر ملفات هواك\n◊￤يوجد في المتجر ملف الردود\n◊￤يتم ادراج الملفات في التحديثات القادمه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n◊￤تدل علامة (✔) الملف مفعل\n".."◊￤تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("HAWAK_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevHAWAK(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("HAWAK_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourceHawak/files_HAWAK/master/files_HAWAK/"..file)
if res == 200 then
os.execute("rm -fr HAWAK_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('HAWAK.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevHAWAK(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourceHawak/files_HAWAK/master/files_HAWAK/"..file)
if res == 200 then
local chek = io.open("HAWAK_Files/"..file,'w+')
...
os.execute('rm -rf HAWAK.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/SourceHawak/HAWAK/master/HAWAK.lua')
os.execute('wget https://raw.githubusercontent.com/SourceHawak/HAWAK/master/start.lua')
dofile('HAWAK.lua')  
return false
end
if text == "تحديث ↝" then
...
database:set(bot_id.."HAWAK:Lock:tagservrbot"..Userid[1],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'HAWAK:'..lock..Userid[1],"del")    
end
...
database:srem(bot_id.."HAWAK:Muted:User"..data.chat_id_, Userid[2])
...
if tonumber(Userid[1]) == tonumber(data.sender_user_id_) then
database:srem(bot_id.."HAWAK:Ban:User"..data.chat_id_, Userid[2])
...
local list = database:smembers(bot_id.."HAWAK:List:Manager"..data.chat_id_)
for k,v in pairs(list) do
if database:get(bot_id.."HAWAK:Add:Rd:Manager:Gif"..v..data.chat_id_) then
database:del(bot_id.."HAWAK:Add:Rd:Manager:Gif"..v..data.chat_id_)   
database:srem(bot_id.."HAWAK:List:Manager"..data.chat_id_,v)
end
end
keyboard = {} 
keyboard.inline_keyboard = {
...
local list = database:smembers(bot_id.."HAWAK:List:Manager"..data.chat_id_)
for k,v in pairs(list) do
if database:get(bot_id.."HAWAK:Add:Rd:Manager:Stekrs"..v..data.chat_id_) then
database:del(bot_id.."HAWAK:Add:Rd:Manager:Stekrs"..v..data.chat_id_)   
database:srem(bot_id.."HAWAK:List:Manager"..data.chat_id_,v)
end
end
keyboard = {} 
...
local list = database:smembers(bot_id.."HAWAK:List:Manager"..data.chat_id_)
for k,v in pairs(list) do
if database:get(bot_id.."HAWAK:Add:Rd:Manager:Text"..v..data.chat_id_) then
database:del(bot_id.."HAWAK:Add:Rd:Manager:Text"..v..data.chat_id_)   
database:srem(bot_id.."HAWAK:List:Manager"..data.chat_id_,v)
end
end
keyboard = {} 
...
local list = database:smembers(bot_id.."HAWAK:List:Manager"..data.chat_id_)
for k,v in pairs(list) do
if database:get(bot_id.."HAWAK:Add:Rd:Manager:File"..v..data.chat_id_) then
database:del(bot_id.."HAWAK:Add:Rd:Manager:File"..v..data.chat_id_)   
database:srem(bot_id.."HAWAK:List:Manager"..data.chat_id_,v)
end
end
keyboard = {} 
...
local list = database:smembers(bot_id.."HAWAK:List:Manager"..data.chat_id_)
for k,v in pairs(list) do
if database:get(bot_id.."HAWAK:Add:Rd:Manager:Vico"..v..data.chat_id_) then
database:del(bot_id.."HAWAK:Add:Rd:Manager:Vico"..v..data.chat_id_)   
database:srem(bot_id.."HAWAK:List:Manager"..data.chat_id_,v)
end
end
keyboard = {} 
...
database:del(bot_id.."HAWAK:Basic:Constructor"..data.chat_id_)
...
database:del(bot_id.."HAWAK:Constructor"..data.chat_id_)
...
database:del(bot_id.."HAWAK:Manager"..data.chat_id_)
...
database:del(bot_id.."HAWAK:Mod:User"..data.chat_id_)
...
database:del(bot_id.."HAWAK:Special:User"..data.chat_id_)
...
database:del(bot_id.."HAWAK:List:Cmd:Group:New"..data.chat_id_)
...
database:del(bot_id.."HAWAK:MN:TF"..data.chat_id_)
...
database:del(bot_id.."HAWAK:GBan:User"..data.chat_id_)
...
database:del(bot_id.."HAWAK:Ban:User"..data.chat_id_)
...
database:del(bot_id.."HAWAK:Muted:User"..data.chat_id_)
...
database:set(bot_id.."HAWAK:Lock:text"..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/HAWAK:Link_Group') then
if tonumber(Text:match('(.*)/HAWAK:Link_Group')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:Link_Group"..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/HAWAK:Chek:Welcome') then
if tonumber(Text:match('(.*)/HAWAK:Chek:Welcome')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:Chek:Welcome"..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/HAWAK:Reply:Manager') and Owner(data) then
if tonumber(Text:match('(.*)/HAWAK:Reply:Manager')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."HAWAK:Reply:Manager"..data.chat_id_)  
...
elseif Text and Text:match('(.*)/HAWAK:Reply:Sudo') and Owner(data) then
if tonumber(Text:match('(.*)/HAWAK:Reply:Sudo')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."HAWAK:Reply:Sudo"..data.chat_id_)  
...
elseif Text and Text:match('(.*)/HAWAK:Kick:Me') then
if tonumber(Text:match('(.*)/HAWAK:Kick:Me')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."HAWAK:Kick:Me"..data.chat_id_)  
...
elseif Text and Text:match('(.*)/HAWAK:Left:Bot') and DevHAWAK(data) then  
if tonumber(Text:match('(.*)/HAWAK:Left:Bot')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."HAWAK:Left:Bot"..data.chat_id_)  
...
elseif Text and Text:match('(.*)/HAWAK:Status:Bc') and DevHAWAK(data) then  
if tonumber(Text:match('(.*)/HAWAK:Status:Bc')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."HAWAK:Status:Bc") 
...
elseif Text and Text:match('(.*)/HAWAK:Fun_Bots') and Owner(data) then    
if tonumber(Text:match('(.*)/HAWAK:Fun_Bots')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."HAWAK:Fun_Bots"..data.chat_id_)
...
elseif Text and Text:match('(.*)/HAWAK:Lock:ID:Bot') and Owner(data) then  
if tonumber(Text:match('(.*)/HAWAK:Lock:ID:Bot')) == tonumber(data.sender_user_id_) then
database:del(bot_id..'HAWAK:Lock:ID:Bot'..data.chat_id_) 
...
elseif Text and Text:match('(.*)/HAWAK:Lock:ID:Bot:Photo') and Owner(data) then  
if tonumber(Text:match('(.*)/HAWAK:Lock:ID:Bot:Photo')) == tonumber(data.sender_user_id_) then
database:del(bot_id..'HAWAK:Lock:ID:Bot:Photo'..data.chat_id_) 
...
elseif Text and Text:match('(.*)/HAWAK:Lock:Games') and Owner(data) then  
if tonumber(Text:match('(.*)/HAWAK:Lock:Games')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:Lock:Games"..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/HAWAK:zhrf_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/HAWAK:zhrf_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:zhrf_Bots"..data.chat_id_,"open")
...
elseif Text and Text:match('(.*)/HAWAK:brj_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/HAWAK:brj_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:brj_Bots"..data.chat_id_,"open")
...
elseif Text and Text:match('(.*)/HAWAK:age_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/HAWAK:age_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:age_Bots"..data.chat_id_,"open")
...
elseif Text and Text:match('(.*)/HAWAK:movie_bot') and Owner(data) then
if tonumber(Text:match('(.*)/HAWAK:movie_bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:movie_bot"..data.chat_id_,"open")
...
elseif Text and Text:match('(.*)/HAWAK:Free:Add:Bots') and DevHAWAK(data) then  
if tonumber(Text:match('(.*)/HAWAK:Free:Add:Bots')) == tonumber(data.sender_user_id_) then
database:del(bot_id..'HAWAK:Free:Add:Bots') 
...
elseif Text and Text:match('(.*)/HAWAK:insta_bot') and Owner(data) then
if tonumber(Text:match('(.*)/HAWAK:insta_bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:insta_bot"..data.chat_id_,"open")
...
elseif Text and Text:match('(.*)/unHAWAK:Link_Group') then
if tonumber(Text:match('(.*)/unHAWAK:Link_Group')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."HAWAK:Link_Group"..data.chat_id_) 
...
elseif Text and Text:match('(.*)/unHAWAK:Chek:Welcome') then
if tonumber(Text:match('(.*)/unHAWAK:Chek:Welcome')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."HAWAK:Chek:Welcome"..data.chat_id_) 
...
elseif Text and Text:match('(.*)/unHAWAK:Reply:Manager') and Owner(data) then
if tonumber(Text:match('(.*)/unHAWAK:Reply:Manager')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:Reply:Manager"..data.chat_id_,true)  
...
elseif Text and Text:match('(.*)/unHAWAK:Reply:Sudo') and Owner(data) then
if tonumber(Text:match('(.*)/unHAWAK:Reply:Sudo')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:Reply:Sudo"..data.chat_id_,true)   
...
elseif Text and Text:match('(.*)/unHAWAK:Kick:Me') then
if tonumber(Text:match('(.*)/unHAWAK:Kick:Me')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:Kick:Me"..data.chat_id_,true)  
...
elseif Text and Text:match('(.*)/unHAWAK:Left:Bot') and DevHAWAK(data) then  
if tonumber(Text:match('(.*)/unHAWAK:Left:Bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:Left:Bot"..data.chat_id_,true)   
...
elseif Text and Text:match('(.*)/unHAWAK:Status:Bc') and DevHAWAK(data) then  
if tonumber(Text:match('(.*)/unHAWAK:Status:Bc')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:Status:Bc",true) 
...
elseif Text and Text:match('(.*)/unHAWAK:Fun_Bots') and Owner(data) then    
if tonumber(Text:match('(.*)/unHAWAK:Fun_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:Fun_Bots"..data.chat_id_,"true")
...
elseif Text and Text:match('(.*)/unHAWAK:Lock:ID:Bot') and Owner(data) then  
if tonumber(Text:match('(.*)/unHAWAK:Lock:ID:Bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id..'HAWAK:Lock:ID:Bot'..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/unHAWAK:Lock:ID:Bot:Photo') and Owner(data) then  
if tonumber(Text:match('(.*)/unHAWAK:Lock:ID:Bot:Photo')) == tonumber(data.sender_user_id_) then
database:set(bot_id..'HAWAK:Lock:ID:Bot:Photo'..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/unHAWAK:Lock:Games') and Owner(data) then  
if tonumber(Text:match('(.*)/unHAWAK:Lock:Games')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."HAWAK:Lock:Games"..data.chat_id_) 
...
elseif Text and Text:match('(.*)/unHAWAK:zhrf_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/unHAWAK:zhrf_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:zhrf_Bots"..data.chat_id_,"close")
...
elseif Text and Text:match('(.*)/unHAWAK:brj_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/unHAWAK:brj_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:brj_Bots"..data.chat_id_,"close")
...
elseif Text and Text:match('(.*)/unHAWAK:age_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/unHAWAK:age_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:age_Bots"..data.chat_id_,"close")
...
elseif Text and Text:match('(.*)/unHAWAK:movie_bot') and Owner(data) then
if tonumber(Text:match('(.*)/unHAWAK:movie_bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:movie_bot"..data.chat_id_,"close")
...
elseif Text and Text:match('(.*)/unHAWAK:Free:Add:Bots') and DevHAWAK(data) then  
if tonumber(Text:match('(.*)/unHAWAK:Free:Add:Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id..'HAWAK:Free:Add:Bots',true) 
...
elseif Text and Text:match('(.*)/unHAWAK:insta_bot') and Owner(data) then
if tonumber(Text:match('(.*)/unHAWAK:insta_bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."HAWAK:insta_bot"..data.chat_id_,"close")
...
{
{text = 'تفعيل الرابط', callback_data=data.sender_user_id_.."/HAWAK:Link_Group"},{text = 'تعطيل الرابط', callback_data=data.sender_user_id_.."/unHAWAK:Link_Group"},
},
{
{text = 'تفعيل الترحيب', callback_data=data.sender_user_id_.."/HAWAK:Chek:Welcome"},{text = 'تعطيل الترحيب', callback_data=data.sender_user_id_.."/unHAWAK:Chek:Welcome"},
},
{
{text = 'تفعيل ردود المدير', callback_data=data.sender_user_id_.."/HAWAK:Reply:Manager"},{text = 'تعطيل ردود المدير', callback_data=data.sender_user_id_.."/unHAWAK:Reply:Manager"},
},
{
{text = 'تفعيل ردود المطور', callback_data=data.sender_user_id_.."/HAWAK:Reply:Sudo"},{text = 'تعطيل ردود المطور', callback_data=data.sender_user_id_.."/unHAWAK:Reply:Sudo"},
},
{
{text = 'تفعيل اطردني', callback_data=data.sender_user_id_.."/HAWAK:Kick:Me"},{text = 'تعطيل اطردني', callback_data=data.sender_user_id_.."/unHAWAK:Kick:Me"},
},
{
{text = 'تفعيل المغادره', callback_data=data.sender_user_id_.."/HAWAK:Left:Bot"},{text = 'تعطيل المغادره', callback_data=data.sender_user_id_.."/unHAWAK:Left:Bot"},
},
{
{text = 'تفعيل الاذاعه', callback_data=data.sender_user_id_.."/HAWAK:Status:Bc"},{text = 'تعطيل الاذاعه', callback_data=data.sender_user_id_.."/unHAWAK:Status:Bc"},
},
{
{text = 'تفعيل اوامر التحشيش', callback_data=data.sender_user_id_.."/HAWAK:Fun_Bots"},{text = 'تعطيل اوامر التحشيش', callback_data=data.sender_user_id_.."/unHAWAK:Fun_Bots"},
},
{
{text = 'تفعيل الايدي ', callback_data=data.sender_user_id_.."/HAWAK:Lock:ID:Bot"},{text = 'تعطيل الايدي', callback_data=data.sender_user_id_.."/unHAWAK:Lock:ID:Bot"},
},
{
{text = 'تفعيل الايدي بالصوره', callback_data=data.sender_user_id_.."/HAWAK:Lock:ID:Bot:Photo"},{text = 'تعطيل الايدي بالصوره', callback_data=data.sender_user_id_.."/unHAWAK:Lock:ID:Bot:Photo"},
},
{
...
{
{text = 'تفعيل الالعاب', callback_data=data.sender_user_id_.."/HAWAK:Lock:Games"},{text = 'تعطيل الالعاب', callback_data=data.sender_user_id_.."/unHAWAK:Lock:Games"},
},
{
...
{
{text = 'تفعيل للزخرفه', callback_data=data.sender_user_id_.."/HAWAK:zhrf_Bots"},{text = 'تعطيل الزخرفه', callback_data=data.sender_user_id_.."/unHAWAK:zhrf_Bots"},
},
{
{text = 'تفعيل الابراج', callback_data=data.sender_user_id_.."/HAWAK:brj_Bots"},{text = 'تعطيل الابراج', callback_data=data.sender_user_id_.."/unHAWAK:brj_Bots"},
},
{
{text = 'تفعيل حساب العمر', callback_data=data.sender_user_id_.."/HAWAK:age_Bots"},{text = 'تعطيل حساب للعمر', callback_data=data.sender_user_id_.."/unHAWAK:age_Bots"},
},
{
{text = 'تفعيل الافلام', callback_data=data.sender_user_id_.."/HAWAK:movie_bot"},{text = 'تعطيل الافلام', callback_data=data.sender_user_id_.."/unHAWAK:movie_bot"},
},
{
{text = 'تفعيل البوت الخدمي', callback_data=data.sender_user_id_.."/HAWAK:Free:Add:Bots"},{text = 'تعطيل البوت الخدمي', callback_data=data.sender_user_id_.."/unHAWAK:Free:Add:Bots"},
},
{
{text = 'تفعيل الانستا', callback_data=data.sender_user_id_.."/HAWAK:insta_bot"},{text = 'تعطيل الانستا', callback_data=data.sender_user_id_.."/unHAWAK:insta_bot"},
},
{
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
◊￤ميزة خاصة بسورس هواك 🐉 .
◊￤ارسل كلمة { بحث } + الكلمة المراد البحث عنها في اليوتيوب مثلا { بحث هواك } سيتم تحميلها على شكل اغنية وارسالها لك 🐉 .
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
◊￤Carbon ≻≻  * ]].. UserName..[[
]]
keyboard = {} 
...
local Teext =[[
اهلا بك في بوت [Hawak team](https://t.me/lllEll2)
...
if database:get(bot_id.."HAWAK:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_) then
database:del(bot_id.."HAWAK:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_)
...
database:del(bot_id..'HAWAK:messageUser'..data.chat_id_..':'..data.sender_user_id_)
keyboard = {} 
...
database:del(bot_id..'HAWAK:message_edit'..data.chat_id_..data.sender_user_id_)
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="DelHome:"..data.sender_user_id_}},{{text="‹ اخفاء الكليشه ›",callback_data="/delamr"..data.sender_user_id_}}}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐇𝐀𝐖𝐀𝐊 TEαM .',url='http://t.me/lllEll2'}},
}
...
if database:get(bot_id.."HAWAK:Left:Bot"..data.sender_user_id_..':'..Chat_id) then 
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐇𝐀𝐖𝐀𝐊 TEαM .',url='http://t.me/lllEll2'}},
}
...
database:srem(bot_id.."HAWAK:List:Filter:Animation"..idchci,animation)  
end
if DAata and DAata:match("^pito(.*)$") and Addictive(data) then  
local idchci = database:get(bot_id.."HAWAK:Filter:msg")
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."HAWAK:List:Filter:Photo"..idchci,photo)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."HAWAK:List:Filter:Sticker"..idchci,Sticker)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listSticker = database:smembers(bot_id.."HAWAK:List:Filter:Sticker"..delallSticker)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."HAWAK:List:Filter:Sticker"..delallSticker,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listAnimation = database:smembers(bot_id.."HAWAK:List:Filter:Animation"..delallmation)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."HAWAK:List:Filter:Animation"..delallmation,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listPhoto = database:smembers(bot_id.."HAWAK:List:Filter:Photo"..delallph)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."HAWAK:List:Filter:Photo"..delallph,v)  
end  
end
end
...
database:del(bot_id..'HAWAK:nwe:mem:group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'\n تم تعطيل تحقق' ) 
end
if text == 'تفعيل تحقق' and Addictive(msg) then  
database:set(bot_id..'HAWAK:nwe:mem:group'..msg.chat_id_,'true') 
send(msg.chat_id_, msg.id_,'\nتم تفعيل تحقق' ) 
end 
--======================================================================================================
--======================================================================================================
...
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'HAWAK:nwe:mem:group'..msg.chat_id_) == 'true'then
numphoto = {'3','8','9','6'}
...
if text and not database:sismember(bot_id..'HAWAK:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'HAWAK:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'HAWAK:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
   if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."HAWAK:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."HAWAK:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
--------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------
if text and database:get(bot_id.."HAWAK:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."HAWAK:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."HAWAK:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."HAWAK:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
...
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."HAWAK:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."HAWAK:Name:Bot") or "هواك")
if not database:get(bot_id.."HAWAK:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
HAWAK_Started_Bot(msg,data)
HAWAK_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'HAWAK:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."HAWAK:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
local list = database:smembers(bot_id.."HAWAK:Basic:Constructor"..msg.chat_id_)
t = "◊￤ المنشئين الاساسين تعالو مخرب \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."HAWAK:User:Name" .. v)
...
if database:get(bot_id.."HAWAK:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."HAWAK:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."HAWAK:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."HAWAK:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local HAWAK_Msg = database:sismember(bot_id.."HAWAK:List:Filter:text"..result.chat_id_,text) 
if HAWAK_Msg then    
...
if msg.content_.ID == 'MessageAnimation' then    
local Animation_Msg = database:sismember(bot_id.."HAWAK:List:Filter:Animation"..result.chat_id_,result.content_.animation_.animation_.persistent_id_) 
...
if msg.content_.ID == 'MessagePhoto' then    
local Photo_Msg = database:sismember(bot_id.."HAWAK:List:Filter:Photo"..result.chat_id_,result.content_.photo_.sizes_[1].photo_.persistent_id_) 
if Photo_Msg then    
...
if msg.content_.ID == 'MessageSticker' then    
local Sticker_Msg = database:sismember(bot_id.."HAWAK:List:Filter:Sticker"..result.chat_id_,result.content_.sticker_.sticker_.persistent_id_) 
if Sticker_Msg then    
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'HAWAK:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'HAWAK:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'HAWAK:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
