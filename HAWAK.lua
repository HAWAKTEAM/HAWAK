...
function CleangGroups();local z = io.open('./Matrix');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/HAWAK.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
...
database:del(bot_id.."Matrix:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Matrix:Set:PMatrixvate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"◊￤تم الغاء حفظ الرابط")       
database:del(bot_id.."Matrix:Set:PMatrixvate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
...
if database:get(bot_id.."Matrix:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◊￤" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء الاذاعه للخاص") 
database:del(bot_id.."Matrix:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
...
if database:get(bot_id.."Matrix:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◊￤" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء الاذاعه") 
database:del(bot_id.."Matrix:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."Matrix:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◊￤" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء الاذاعه") 
database:del(bot_id.."Matrix:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."Matrix:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◊￤" then   
send(msg.chat_id_, msg.id_,"◊￤تم الغاء الاذاعه") 
database:del(bot_id.."Matrix:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."Matrix:UsersBot")   
...
send(msg.chat_id_, msg.id_,"◊￤العضو ⇠ ["..data.first_name_.."](t.me/"..(data.username_ or "Matrix_Source")..")".."\n◊￤تم رفعه "..RTPA.." هنا\n")
...
if Matrixrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"◊￤العضو ⇠ ["..result.title_.."](t.me/"..(text1[3] or "Matrix_Source")..")".."\n◊￤تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Matrix:Special:User"..msg.chat_id_,result.id_)  
...
database:set(bot_id..'Matrix:lock:Engilsh'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","*◊￤تم قفل الانكليزيه*")  
end
if text and database:get(bot_id..'Matrix:lock:Engilsh'..msg.chat_id_) and not Constructor(msg) then 
...
database:del(bot_id..'Matrix:lock:Engilsh'..msg.chat_id_) 
...
if text == (database:get(bot_id.."Matrix:Name:Bot") or "هواك") then
Namebot = (database:get(bot_id.."Matrix:Name:Bot") or "هواك")
local namebot = {
'لابسك لتلح',
'لاتوصخ اسمي',
'هاقلبي؟ كول',
...
database:setex(bot_id.."Matrix:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Matrix:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Matrix:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◊￤ارسل لي التوجيه الان") 
return false
end 
...
if text == 'تحديث هواك' and DevMatrix(msg) then
...
if text == "مسح جميع الملفات" or text == 'مسح جميع الملفات ↝' and DevMatrix(msg) then
os.execute("rm -fr Matrix_Files/*")
send(msg.chat_id_,msg.id_,"◊￤تم حذف جميع الملفات")
return false
end
if text == "متجر الملفات ↝" or text == 'المتجر' and DevMatrix(msg) then
if DevMatrix(msg) then
...
database:del(bot_id.."Matrix:GBan:User"..data.chat_id_)
...
local Name_Bot = (database:get(bot_id.."Matrix:Name:Bot") or "هواك")
