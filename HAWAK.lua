...
io.popen("cd library && wget https://raw.githubusercontent.com/HAWAKTEAM/HAWAK/main/library/redis.lua") 
...
if hash or SudoBot(msg) or HAWAK(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or HAWAK(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or HAWAK(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or HAWAK(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or HAWAK(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or HAWAK(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or HAWAK(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
--------------------------------------------------------------------------------------------------------------
function SourceHAWAK(msg,data) -- بداية العمل ليث الـ عبيد
if msg then
...
Namot = (database:get(bot_id..'Name:Bot') or 'هواك')
...
local list = database:smembers(bot_id.."HAWAK1:List:Filter"..sl)
...
if not HAWAK(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if HAWAK(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ⌯' and HAWAK(msg) then  
...
if text == 'تعطيل التواصل ⌯' and HAWAK(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and HAWAK(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and HAWAK(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and HAWAK(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and HAWAK(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and HAWAK(msg) then 
...
if text == 'تحديث السورس ⌯' and HAWAK(msg) then 
os.execute('rm -rf HAWAK.lua')
os.execute('wget https://raw.githubusercontent.com/HAWAKTEAM/HAWAK/main/HAWAK.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس هواك*\n*⌯︙الاصدار » { 2.8v}*')
dofile('HAWAK.lua')  
end
if text == 'الاصدار ⌯' and HAWAK(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس هواك* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and HAWAK(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/lllEll2) \n⌯︙[قناه اسورس](t.me/lllEll2)')
end
if text == "ضع اسم للبوت ⌯" and HAWAK(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and HAWAK(msg) then 
...
if text == 'المشتركين ⌯' and HAWAK(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and HAWAK(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and HAWAK(msg) then
...
if text == ("قائمه العام ⌯") and HAWAK(msg) then
...
if text == ("قائمه الكتم العام ⌯") and HAWAK(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and HAWAK(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and HAWAK(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and HAWAK(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and HAWAK(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and HAWAK(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and HAWAK(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and HAWAK(msg) then
...
if text == "تنظيف الكروبات ⌯" and HAWAK(msg) then 
...
if text and text:match("^رفع مطور @(.*)$") and HAWAK(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and HAWAK(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and HAWAK(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and HAWAK(msg) then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not HAWAK(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and HAWAK(msg) then
...
if text and text:match("^تغير الاشتراك$") and HAWAK(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and HAWAK(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and HAWAK(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and HAWAK(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and HAWAK(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and HAWAK(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and HAWAK(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
if t2.id_ then 
name_HAWAK = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_HAWAK then 
names_HAWAK = database:smembers(bot_id.."HAWAK:blocname"..msg.chat_id_) or ""
if names_HAWAK and names_HAWAK[1] then 
for i=1,#names_HAWAK do 
if name_HAWAK:match("(.*)("..names_HAWAK[i]..")(.*)") then 
...
function amir_HAWAKa_new(HAWAK1,HAWAK2)
if HAWAK2 and HAWAK2.first_name_ then 
if HAWAK2.first_name_:match("(.*)"..database:get(bot_id.."HAWAK:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."HAWAK:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local HAWAK_nnn = database:get(bot_id.."HAWAK:nump"..msg.chat_id_) or 5
local HAWAK_nnn2 = database:get(bot_id.."HAWAK:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(HAWAK_nnn2) == tonumber(HAWAK_nnn) or tonumber(HAWAK_nnn2) > tonumber(HAWAK_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."HAWAK:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..HAWAK2.username_.."](https://t.me/"..(HAWAK2.username_ or "vvvmh")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."HAWAK:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(HAWAK_nnn) - tonumber(HAWAK_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_HAWAKa_new)
end
end
...
local url,res = https.request('https://vvvzvv.ml/apiHAWAK/HAWAK.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'⌯︙شترك في قناة السورس اولآ @lllEll2 .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ 𝙷𝙰𝚆𝙰𝙺\n\n[⌯  𝙷𝙰𝚆𝙰𝙺 ᴄʜᴀɴɴᴇʟ](http://t.me/lllEll2)\n\n[⌯  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/lllEll2)\n\n[⌯  𝙷𝙰𝚆𝙰𝙺 ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/IMMHH)\n\n[⌯  ʙᴏᴛ 𝙷𝙰𝚆𝙰𝙺](http://t.me/Tilllandbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ sᴏᴜʀᴄʀ 𝙷𝙰𝚆𝙰𝙺',url="t.me/lllEll2/3"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع نسخه الاحتياطيه' and HAWAK(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ ليث العبيدي
if text == 'تحديث' and HAWAK(msg) then
dofile('HAWAK.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and HAWAK(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and HAWAK(msg) then  
function start_function(extra, result, success)
if HAWAKSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and HAWAK(msg) then  
...
if HAWAKSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and HAWAK(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if HAWAKSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and HAWAK(msg) then  
function start_function(extra, result, success)
if HAWAKSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and HAWAK(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and HAWAK(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if HAWAKSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and HAWAK(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and HAWAK(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and HAWAK(msg) then  
...
------------------------------------------------------------------------ ليث العبيدي
if text == ("مسح المطورين") and HAWAK(msg) then
...
if text == 'الملفات' and HAWAK(msg) then
t = ' *⌯︙ملفات السورس هواك ↓*\n*•━━━━━━ 𝐇𝐖𝐊 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and HAWAK(msg) then
...
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس هواك* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and HAWAK(msg) then
...
if text == "مسح الملفات" and HAWAK(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and HAWAK(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and HAWAK(msg) then  
function start_function(extra, result, success)
...
local TEXT_SUD = database:get(bot_id..'HAWAK:TEXT_SUDO')
if TEXT_SUDO then 
...
if text == 'مسح كليشه المطور' and HAWAK(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and HAWAK(msg) then
...
if text == 'تفعيل الاذاعه' and HAWAK(msg) then  
...
if text == 'تعطيل الاذاعه' and HAWAK(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'هواك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'هواك')
local HAWAK_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
if database:get(bot_id..'Bc:Bots') and not HAWAK(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,HAWAK)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝐇𝐖𝐊 ━━━━━━━•*\n"
x = 0
...
if HAWAKSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and HAWAK(msg) then 
...
if text == ("ردود المطور") and HAWAK(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝐇𝐖𝐊 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and HAWAK(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and HAWAK(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'هواك').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and HAWAK(msg) then   
...
if text == 'تعطيل المغادره' and HAWAK(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'HAWAKTEAM')..') '
...
if text == 'استعاده الاوامر' and HAWAK(msg) then
...
{{text = '𝐻𝐴𝑊𝐴𝐾 𝑇𝐸𝐴𝑀', url="t.me/lllEll2"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://vvvzvv.ml/amirZhfa/HAWAK.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ 𝐇𝐖𝐊 ━━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ 𝐇𝐖𝐊 ━━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[𝐻𝐴𝑊𝐴𝐾 𝑇𝐸𝐴𝑀](t.me/lllEll2) ')
end
...
gk = https.request('https://vvvzvv.ml/amirBrg/HAWAK.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/HAWAK.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/HAWAK.php')
if res == 200 then
...
{{text = 'sᴏᴜʀᴄʀ 𝙷𝙰𝚆𝙰𝙺',url='http://t.me/lllEll2'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'هواك')
